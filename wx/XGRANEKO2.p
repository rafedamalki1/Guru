...
IF globforetag = "ELPA" THEN DO: 
   ...
   prognamnk = "\\pc012\D\DELAD\PRO9\guru\EXPORT\EXKOPIA\"                                                     
...
FOR EACH sumkont:
  ...
  /*iedimi1*/
   ...
   /*iedimi3*/ /*aonrkont.k2*/
   SUBSTRING(str,utnrIBT[nrcolIBT[4]]) = sumkont.TD 
   /*iedimi4*/ /*aonrkont.k1*/
   SUBSTRING(str,utnrIBT[nrcolIBT[5]]) = sumkont.AONR       
