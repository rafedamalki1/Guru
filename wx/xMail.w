...
DEFINE FRAME DEFAULT-FRAME
     ...
     NewMailButton AT ROW 2.27 COL 81.25
     vMessage AT ROW 11.18 COL 1 NO-LABEL
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW C-Win ASSIGN
         ...
         MAX-HEIGHT         = 24.68
         MAX-WIDTH          = 132.75
         VIRTUAL-HEIGHT     = 24.68
         VIRTUAL-WIDTH      = 132.75
         RESIZE             = yes
         SCROLL-BARS        = no
         STATUS-AREA        = no
         BGCOLOR            = ?
...
/* CtrlFrame OCXINFO:CREATE-CONTROL from: {CFCDAA03-8BE4-11CF-B84B-0020AFBBCCFA} type: RealAudio */
      CtrlFrame:MOVE-AFTER(NewMailButton:HANDLE IN FRAME DEFAULT-FRAME).
...
END.
ELSE MESSAGE "xMail.wrx":U SKIP(1)
