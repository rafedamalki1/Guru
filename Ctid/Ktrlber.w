...
&Scoped-Define ENABLED-OBJECTS BTN_SKRIV BTN_AVB 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 101.5 BY 25.5.
...
DEFINE FRAME FRAME-TIDS
     ...
     BTN_BYT AT ROW 27.92 COL 59.13
     BTN_SKRIV AT ROW 27.92 COL 74.13
     BTN_AVB AT ROW 27.92 COL 89
...
/* SETTINGS FOR BUTTON BTN_BYT IN FRAME FRAME-TIDS
   NO-ENABLE                                                            */
ASSIGN 
       BTN_BYT:HIDDEN IN FRAME FRAME-TIDS           = TRUE.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BTN_BYT WINDOW-2
ON CHOOSE OF BTN_BYT IN FRAME FRAME-TIDS /* Byt lart */
DO:
  IF Guru.Konstanter:appcon THEN DO:                                 
      RUN APBYTBER.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT 
...
"===========================================================================================================".        
   ...
   IF Guru.Konstanter:appcon THEN DO:                                 
      RUN APKTBER.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT 
      (INPUT TABLE invartemp, INPUT TABLE tidpers, OUTPUT TABLE tidut).
   END.
   ELSE DO:
      RUN APKTBER.P 
   ...
   END.
   ELSE DO:
      MESSAGE "Ingen av sökta personers har registrerat sjukdom vid beredskap under månad " MONTH(avdatum) "-" YEAR(avdatum)
      VIEW-AS ALERT-BOX.      
