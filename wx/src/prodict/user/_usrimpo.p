...
DEFINE NEW SHARED VARIABLE pik_lower  AS INTEGER   EXTENT 0640 NO-UNDO.
DEFINE NEW SHARED VARIABLE pik_upper  AS INTEGER   EXTENT 0640 NO-UNDO.
...
&GLOBAL-DEFINE ARMSG_ROW_OFFSET + 0.4
&ELSE
