...
DEFINE VARIABLE IMAGE-5h AS HANDLE NO-UNDO.
DEFINE VARIABLE CMB_MANh AS HANDLE NO-UNDO.
...
DEFINE VARIABLE gurufragah AS HANDLE NO-UNDO.
...
anvandartemp.PERSONALKOD anvandartemp.SPARRAD anvandartemp.SPARR-DATUMTID ~
anvandartemp.SPARRAD-AV anvandartemp.SKAPAD-AV anvandartemp.SKAPAD-DATUMTID ~
anvandartemp.KATEGORI anvandartemp.FAKTURAREF 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BRW_ANV anvandartemp.SPARRAD ~
anvandartemp.KATEGORI anvandartemp.FAKTURAREF 
...
&Scoped-Define ENABLED-OBJECTS BTN_ARENDE BTN_SKARM BTN_EBRKAT IMAGE-4 ~
...
DEFINE BUTTON BTN_NYTTLOSEN 
     LABEL "Skicka nytt Lösen":L 
     SIZE 12 BY 1.
...
DEFINE VARIABLE FILL-IN-E-1 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-E-2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-E-3 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-E-4 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-E-5 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.
...
DEFINE VARIABLE FILL-IN-F3 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 24 BY 1.21
     FONT 17 NO-UNDO.

DEFINE VARIABLE FILL-IN-F4 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 24 BY 1.21
     FONT 17 NO-UNDO.

DEFINE VARIABLE FILL-IN-F5 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 24 BY 1.21
     FONT 17 NO-UNDO.

DEFINE VARIABLE FILL-IN-F6 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 24 BY 1.21
     FONT 17 NO-UNDO.
...
DEFINE VARIABLE FILL-IN-FRO AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 78.5 BY 2
     BGCOLOR 23  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO1 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 69.5 BY 2
     BGCOLOR 19  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 55.5 BY 2
     BGCOLOR 18  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO3 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 69.5 BY 2
     BGCOLOR 19  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO4 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 55.5 BY 2
     BGCOLOR 18  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO5 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 69.5 BY 2
     BGCOLOR 19  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO6 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 55.5 BY 2
     BGCOLOR 18  NO-UNDO.

DEFINE VARIABLE FILL-IN-FRO7 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 69.5 BY 2
     BGCOLOR 19  NO-UNDO.

DEFINE VARIABLE FILL-IN-FT1 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 67 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT1DEL2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 80.5 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 67 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT2DEL2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 80.5 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT3 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 67 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT3DEL2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 80.5 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT4 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 67 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT4DEL2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 80.5 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT5 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 67 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT5DEL2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 80.5 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT6 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 67 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-FT6DEL2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 80.5 BY .63 NO-UNDO.
...
DEFINE VARIABLE FILL-IN-GFTEXTS1-1 AS CHARACTER FORMAT "X(256)":U INITIAL "KUNDUNDERSÖKNING - ditt svar är värdefullt!" 
      VIEW-AS TEXT 
     SIZE 86 BY 1.21
     FONT 17 NO-UNDO.

DEFINE VARIABLE FILL-IN-GFTEXTS1-2 AS CHARACTER FORMAT "X(256)":U INITIAL "Min användarroll i Guru är:" 
      VIEW-AS TEXT 
     SIZE 86 BY 1.21
     FONT 17 NO-UNDO.

DEFINE VARIABLE FILL-IN-GFTEXTS1-3 AS CHARACTER FORMAT "X(256)":U INITIAL "(man kan ange flera)" 
      VIEW-AS TEXT 
     SIZE 86 BY 1.21
     FONT 17 NO-UNDO.
...
DEFINE VARIABLE FILL-IN-V-1 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-V-2 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-V-3 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-V-4 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE FILL-IN-V-5 AS CHARACTER FORMAT "X(256)":U 
      VIEW-AS TEXT 
     SIZE 1 BY .63 NO-UNDO.

DEFINE VARIABLE TOG_E-1 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-10 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-11 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-12 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-13 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-14 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-15 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-16 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-17 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-18 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-19 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-2 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-20 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-21 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-22 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-23 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-24 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-25 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-26 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-27 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-28 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-29 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-3 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-30 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-4 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-5 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-6 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-7 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-8 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_E-9 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.
...
DEFINE VARIABLE TOG_V-1 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-10 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-11 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-12 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-13 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-14 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-15 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-16 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-17 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-18 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-19 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-2 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-20 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-21 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-22 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-23 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-24 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-25 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-26 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-27 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-28 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-29 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-3 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-30 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-4 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-5 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-6 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-7 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-8 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.

DEFINE VARIABLE TOG_V-9 AS LOGICAL INITIAL no 
     LABEL "" 
     VIEW-AS TOGGLE-BOX
     SIZE 1.5 BY .58
     BGCOLOR 15  NO-UNDO.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW_ANV C-Win _STRUCTURED
  QUERY BRW_ANV NO-LOCK DISPLAY
      ...
      anvandartemp.PERSONALKOD COLUMN-LABEL "Enhet/!Sign" FORMAT "x(256)":U
            WIDTH 7
      anvandartemp.SPARRAD COLUMN-LABEL "Spärrad" FORMAT "JA/NEJ":U
            VIEW-AS TOGGLE-BOX
      anvandartemp.SPARR-DATUMTID COLUMN-LABEL "Spärrad fom" FORMAT "99/99/99":U
      anvandartemp.SPARRAD-AV COLUMN-LABEL "Spärrad av" FORMAT "x(256)":U
            WIDTH 12
      anvandartemp.SKAPAD-AV COLUMN-LABEL "Skapad av" FORMAT "x(256)":U
            WIDTH 12
      anvandartemp.SKAPAD-DATUMTID COLUMN-LABEL "Skapad" FORMAT "99/99/99":U
      anvandartemp.KATEGORI COLUMN-LABEL "Kategori" FORMAT "x(256)":U
            WIDTH 8
      anvandartemp.FAKTURAREF COLUMN-LABEL "Faktura" FORMAT "x(256)":U
            WIDTH 8
  ENABLE
      anvandartemp.SPARRAD
...
DEFINE FRAME FRAME-ANV
     ...
     BTN_NYTTLOSEN AT ROW 21 COL 88.5 WIDGET-ID 2
...
DEFINE FRAME FRAME-GURUFRAGOR
     ...
     BTN_NEXT AT ROW 16.58 COL 65.13 WIDGET-ID 50
     FILL-IN-FRIFORSLAG AT ROW 17 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 58
     TOG_E-3 AT ROW 19 COL 32.5 WIDGET-ID 116
     TOG_E-19 AT ROW 19 COL 32.5 WIDGET-ID 264
     TOG_E-16 AT ROW 19 COL 32.5 WIDGET-ID 258
     TOG_E-7 AT ROW 19 COL 32.5 WIDGET-ID 240
     TOG_E-17 AT ROW 19 COL 32.5 WIDGET-ID 260
     TOG_E-8 AT ROW 19 COL 32.5 WIDGET-ID 242
     TOG_E-6 AT ROW 19 COL 32.5 WIDGET-ID 238
     TOG_E-4 AT ROW 19 COL 32.5 WIDGET-ID 118
     TOG_E-30 AT ROW 19 COL 32.5 WIDGET-ID 286
     TOG_E-20 AT ROW 19 COL 32.5 WIDGET-ID 266
     TOG_E-21 AT ROW 19 COL 32.5 WIDGET-ID 268
     TOG_E-22 AT ROW 19 COL 32.5 WIDGET-ID 270
     TOG_E-23 AT ROW 19 COL 32.5 WIDGET-ID 272
     TOG_E-24 AT ROW 19 COL 32.5 WIDGET-ID 274
     TOG_E-25 AT ROW 19 COL 32.5 WIDGET-ID 276
     TOG_E-26 AT ROW 19 COL 32.5 WIDGET-ID 278
     TOG_E-27 AT ROW 19 COL 32.5 WIDGET-ID 280
     TOG_E-28 AT ROW 19 COL 32.5 WIDGET-ID 282
     TOG_E-15 AT ROW 19 COL 32.5 WIDGET-ID 256
     TOG_E-11 AT ROW 19 COL 32.5 WIDGET-ID 248
     TOG_E-14 AT ROW 19 COL 32.5 WIDGET-ID 254
     TOG_E-13 AT ROW 19 COL 32.5 WIDGET-ID 252
     TOG_E-12 AT ROW 19 COL 32.5 WIDGET-ID 250
     TOG_E-5 AT ROW 19 COL 32.5 WIDGET-ID 120
     TOG_E-29 AT ROW 19 COL 32.5 WIDGET-ID 284
     TOG_E-9 AT ROW 19 COL 32.5 WIDGET-ID 244
     TOG_E-10 AT ROW 19 COL 32.5 WIDGET-ID 246
     TOG_E-18 AT ROW 19 COL 32.5 WIDGET-ID 262
     TOG_E-1 AT ROW 19 COL 32.5 WIDGET-ID 112
     TOG_E-2 AT ROW 19.17 COL 32 WIDGET-ID 114
     TOG_V-10 AT ROW 19.25 COL 24 WIDGET-ID 196
     TOG_V-15 AT ROW 19.25 COL 24 WIDGET-ID 206
     TOG_V-19 AT ROW 19.25 COL 24 WIDGET-ID 214
     TOG_V-11 AT ROW 19.25 COL 24 WIDGET-ID 198
     TOG_V-4 AT ROW 19.25 COL 24 WIDGET-ID 108
     TOG_V-2 AT ROW 19.25 COL 24 WIDGET-ID 104
     TOG_V-5 AT ROW 19.25 COL 24 WIDGET-ID 110
     TOG_V-3 AT ROW 19.25 COL 24 WIDGET-ID 106
     TOG_V-13 AT ROW 19.25 COL 24 WIDGET-ID 202
     TOG_V-6 AT ROW 19.25 COL 24 WIDGET-ID 188
     TOG_V-7 AT ROW 19.25 COL 24 WIDGET-ID 190
     TOG_V-8 AT ROW 19.25 COL 24 WIDGET-ID 192
     TOG_V-9 AT ROW 19.25 COL 24 WIDGET-ID 194
     TOG_V-30 AT ROW 19.25 COL 24 WIDGET-ID 236
     TOG_V-23 AT ROW 19.25 COL 24 WIDGET-ID 222
     TOG_V-18 AT ROW 19.25 COL 24 WIDGET-ID 212
     TOG_V-22 AT ROW 19.25 COL 24 WIDGET-ID 220
     TOG_V-24 AT ROW 19.25 COL 24 WIDGET-ID 224
     TOG_V-12 AT ROW 19.25 COL 24 WIDGET-ID 200
     TOG_V-26 AT ROW 19.25 COL 24 WIDGET-ID 228
     TOG_V-29 AT ROW 19.25 COL 24 WIDGET-ID 234
     TOG_V-14 AT ROW 19.25 COL 24 WIDGET-ID 204
     TOG_V-25 AT ROW 19.25 COL 24 WIDGET-ID 226
     TOG_V-16 AT ROW 19.25 COL 24 WIDGET-ID 208
     TOG_V-17 AT ROW 19.25 COL 24 WIDGET-ID 210
     TOG_V-21 AT ROW 19.25 COL 24 WIDGET-ID 218
     TOG_V-20 AT ROW 19.25 COL 24 WIDGET-ID 216
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1.5 ROW 3.75
         SIZE 97.5 BY 19.75 WIDGET-ID 300.

/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME FRAME-GURUFRAGOR
     TOG_V-27 AT ROW 19.25 COL 24 WIDGET-ID 230
     TOG_V-28 AT ROW 19.25 COL 24 WIDGET-ID 232
     TOG_V-1 AT ROW 19.42 COL 23.5 WIDGET-ID 102
     FILL-IN-GFTEXT1 AT ROW 1.75 COL 3 NO-LABEL WIDGET-ID 76
     FILL-IN-GFTEXTS1-1 AT ROW 2.75 COL 3 NO-LABEL WIDGET-ID 142
     FILL-IN-GFTEXTS1-2 AT ROW 2.75 COL 3 NO-LABEL WIDGET-ID 144
     FILL-IN-GFTEXTS1-3 AT ROW 2.75 COL 3 NO-LABEL WIDGET-ID 146
     ...
     FILL-IN-FRO AT ROW 11.75 COL 1.5 COLON-ALIGNED NO-LABEL WIDGET-ID 2
     FILL-IN-R8 AT ROW 12.25 COL 83.88 COLON-ALIGNED NO-LABEL WIDGET-ID 26
     FILL-IN-F2 AT ROW 12.92 COL 3 NO-LABEL WIDGET-ID 158
     FILL-IN-F3 AT ROW 12.92 COL 3 NO-LABEL WIDGET-ID 160
     FILL-IN-F5 AT ROW 12.92 COL 3 NO-LABEL WIDGET-ID 164
     FILL-IN-F4 AT ROW 12.92 COL 3 NO-LABEL WIDGET-ID 162
     FILL-IN-F1 AT ROW 12.92 COL 3 NO-LABEL WIDGET-ID 28
     FILL-IN-F6 AT ROW 12.92 COL 3 NO-LABEL WIDGET-ID 166
     ...
     FILL-IN-R9 AT ROW 13.5 COL 82.5 COLON-ALIGNED NO-LABEL WIDGET-ID 20
     FILL-IN-FRO1 AT ROW 14.5 COL 3.5 NO-LABEL WIDGET-ID 100
     FILL-IN-FRO3 AT ROW 14.5 COL 3.5 NO-LABEL WIDGET-ID 148
     FILL-IN-FRO5 AT ROW 14.5 COL 3.5 NO-LABEL WIDGET-ID 150
     FILL-IN-FRO7 AT ROW 14.5 COL 3.5 NO-LABEL WIDGET-ID 152
     FILL-IN-FT5DEL2 AT ROW 15 COL 3 NO-LABEL WIDGET-ID 184
     FILL-IN-FT6DEL2 AT ROW 15 COL 3 NO-LABEL WIDGET-ID 186
     FILL-IN-FT3DEL2 AT ROW 15 COL 3 NO-LABEL WIDGET-ID 180
     FILL-IN-FT2DEL2 AT ROW 15 COL 3 NO-LABEL WIDGET-ID 178
     FILL-IN-FT1DEL2 AT ROW 15 COL 3 NO-LABEL WIDGET-ID 54
     FILL-IN-FT4DEL2 AT ROW 15 COL 3 NO-LABEL WIDGET-ID 182
     FILL-IN-FT1 AT ROW 15.42 COL 3 NO-LABEL WIDGET-ID 32
     FILL-IN-FT3 AT ROW 15.42 COL 3 NO-LABEL WIDGET-ID 170
     FILL-IN-FT6 AT ROW 15.42 COL 3 NO-LABEL WIDGET-ID 176
     FILL-IN-FT4 AT ROW 15.42 COL 3 NO-LABEL WIDGET-ID 172
     FILL-IN-FT2 AT ROW 15.42 COL 3 NO-LABEL WIDGET-ID 168
     FILL-IN-FT5 AT ROW 15.42 COL 3 NO-LABEL WIDGET-ID 174
     FILL-IN-GFKOM AT ROW 16.42 COL 10 COLON-ALIGNED NO-LABEL WIDGET-ID 74
     FILL-IN-FRO6 AT ROW 16.58 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 156
     FILL-IN-FRO4 AT ROW 16.58 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 154
     FILL-IN-FRO2 AT ROW 16.58 COL 1 COLON-ALIGNED NO-LABEL WIDGET-ID 6
     FILL-IN-V-5 AT ROW 18.5 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 130
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1.5 ROW 3.75
         SIZE 97.5 BY 19.75 WIDGET-ID 300.
...
/* DEFINE FRAME statement is approaching 4K Bytes.  Breaking it up   */
DEFINE FRAME FRAME-GURUFRAGOR
     FILL-IN-V-4 AT ROW 18.5 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 128
     FILL-IN-V-3 AT ROW 18.5 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 126
     FILL-IN-V-2 AT ROW 18.5 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 124
     FILL-IN-V-1 AT ROW 18.5 COL 39 COLON-ALIGNED NO-LABEL WIDGET-ID 122
     FILL-IN-E-5 AT ROW 18.75 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 140
     FILL-IN-E-4 AT ROW 18.75 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 138
     FILL-IN-E-3 AT ROW 18.75 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 136
     FILL-IN-E-2 AT ROW 18.75 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 134
     FILL-IN-E-1 AT ROW 18.75 COL 42 COLON-ALIGNED NO-LABEL WIDGET-ID 132
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1.5 ROW 3.75
         SIZE 97.5 BY 19.75 WIDGET-ID 300.
...
/* SETTINGS FOR FRAME FRAME-GURUFRAGOR
                                                                        */
/* SETTINGS FOR FILL-IN FILL-IN-E-1 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-E-2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-E-3 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-E-4 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-E-5 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FILL-IN FILL-IN-F3 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-F3:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-F4 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-F4:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-F5 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-F5:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-F6 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-F6:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FRO1 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN FILL-IN-FRO3 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN FILL-IN-FRO5 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN FILL-IN-FRO7 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
/* SETTINGS FOR FILL-IN FILL-IN-FT1 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT1:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT1DEL2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT1DEL2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT2DEL2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT2DEL2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT3 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT3:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT3DEL2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT3DEL2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT4 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT4:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT4DEL2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT4DEL2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT5 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT5:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT5DEL2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT5DEL2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT6 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT6:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-FT6DEL2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE ALIGN-L                                                    */
ASSIGN 
       FILL-IN-FT6DEL2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN-GFTEXTS1-1 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
ASSIGN 
       FILL-IN-GFTEXTS1-1:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-GFTEXTS1-2 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
ASSIGN 
       FILL-IN-GFTEXTS1-2:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.

/* SETTINGS FOR FILL-IN FILL-IN-GFTEXTS1-3 IN FRAME FRAME-GURUFRAGOR
   ALIGN-L                                                              */
ASSIGN 
       FILL-IN-GFTEXTS1-3:READ-ONLY IN FRAME FRAME-GURUFRAGOR        = TRUE.
...
/* SETTINGS FOR FILL-IN FILL-IN-V-1 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-V-2 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-V-3 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-V-4 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
/* SETTINGS FOR FILL-IN FILL-IN-V-5 IN FRAME FRAME-GURUFRAGOR
   NO-ENABLE                                                            */
...
/* BROWSE-TAB BRW_GODK BTN_VISA-8 FRAME-TID */
/* BROWSE-TAB BRW_ANSV BRW_GODK FRAME-TID */
/* BROWSE-TAB BRW_PERS BRW_ANSV FRAME-TID */
...
"ANVANDARE" "Användare" "x(256)" "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.anvandartemp.AV-NAMN
"AV-NAMN" "Användarnamn" "x(256)" "character" ? ? ? ? ? ? no ? no no "40" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.anvandartemp.AV-LEVEL
"AV-LEVEL" "Anv.!Nivå" ">>>9" "integer" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[4]   > Temp-Tables.anvandartemp.OMRADE
"OMRADE" "Område" "X(5)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[5]   > Temp-Tables.anvandartemp.PERSONALKOD
"PERSONALKOD" "Enhet/!Sign" "x(256)" "character" ? ? ? ? ? ? no ? no no "7" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[6]   > Temp-Tables.anvandartemp.SPARRAD
"SPARRAD" "Spärrad" ? "logical" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _FldNameList[7]   > Temp-Tables.anvandartemp.SPARR-DATUMTID
"SPARR-DATUMTID" "Spärrad fom" "99/99/99" "datetime" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[8]   > Temp-Tables.anvandartemp.SPARRAD-AV
"SPARRAD-AV" "Spärrad av" "x(256)" "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[9]   > Temp-Tables.anvandartemp.SKAPAD-AV
"SKAPAD-AV" "Skapad av" "x(256)" "character" ? ? ? ? ? ? no ? no no "12" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[10]   > Temp-Tables.anvandartemp.SKAPAD-DATUMTID
"SKAPAD-DATUMTID" "Skapad" "99/99/99" "datetime" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[11]   > Temp-Tables.anvandartemp.KATEGORI
"KATEGORI" "Kategori" "x(256)" "character" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[12]   > Temp-Tables.anvandartemp.FAKTURAREF
"FAKTURAREF" "Faktura" "x(256)" "character" ? ? ? ? ? ? yes ? no no "8" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is NOT OPENED
*/  /* BROWSE BRW_ANV */
&ANALYZE-RESUME
...
ON WINDOW-CLOSE OF {&WINDOW-NAME} DO:   
   ...
   END.
   ELSE DO:
       IF FRAME FRAME-SEK:HIDDEN = FALSE THEN DO:
          RUN SekAvb_UI IN Guru.SharedVariable:btnsekh.
          QUIT.
       END.    
       ELSE RUN avb_UI.     
...
/*GURUSUPPORT*/
   IF Guru.Konstanter:globanv = CHR(71) + CHR(85) + CHR(82) + CHR(85) + CHR(83) + CHR(85) + CHR(80) + CHR(80) + CHR(79) + CHR(82) + CHR(84)  THEN DO:
      BTN_GURU:HIDDEN = TRUE.  
      APPLY "CHOOSE" TO BTN_SEKM IN FRAME AMULTISTART-FRAME. 
   END.
   IF TODAY <= 12/24/21 THEN DO:
      FRAME FRAME-GURUFRAGOR:HIDDEN = TRUE.
      ...
      IF VALID-HANDLE(edataapph) THEN DO:               
         ...
         ELSE DO:
            ...
            IF musz = TRUE THEN DO:
               ...
               IF VALID-HANDLE(edataapph) THEN DELETE PROCEDURE edataapph NO-ERROR. 
               edataapph = ?.
               IMAGE-5h = IMAGE-5:HANDLE. 
               CMB_MANh = CMB_MAN:HANDLE.
               RUN GuruFragor_UI.
            END.
...
------------------------------------------------------------------------------*/
   IF NOT VALID-HANDLE(btnguruh) THEN DO:
      ...
      RUN ControlsCopy_UI IN btnguruh.
   END.
END PROCEDURE.
...
------------------------------------------------------------------------------*/
   ...
   RUN whandle_UI (INPUT-OUTPUT ordningnr,anvandartemp.SPARRAD:HANDLE IN BROWSE BRW_ANV).
   RUN whandle_UI (INPUT-OUTPUT ordningnr,anvandartemp.SPARR-DATUMTID:HANDLE IN BROWSE BRW_ANV).
   RUN whandle_UI (INPUT-OUTPUT ordningnr,anvandartemp.SPARRAD-AV:HANDLE IN BROWSE BRW_ANV).   
   ...
   RUN whandle_UI (INPUT-OUTPUT ordningnr,BTN_NYTTLOSEN:HANDLE IN FRAME FRAME-ANV).
...
------------------------------------------------------------------------------*/
  ENABLE BTN_ARENDE BTN_SKARM BTN_EBRKAT IMAGE-4 RECT-MENY BTN_MTRLM BTN_AONR 
  ...
  ENABLE IMAGE-15 RECT-26 BRW_ANV BTN_NY-11 BTN_UPP-11 BTN_BORT-11 BTN_VISA-11 
         BTN_NYTTLOSEN FILL-IN_SANVANDARE-11 FILL-IN_SNAMN-11 FILL-IN_TEXTANV 
      WITH FRAME FRAME-ANV IN WINDOW C-Win.
  ...
  ENABLE IMAGE-7 BTN_ALLOVER-2 RECT-22 RECT-62 TOG_AKT-2 TOG_INAKT-2 TOG_BERAO 
         TOG_SCH BTN_ALLBACK-2 CMB_JURP-2 CMB_AVD-2 CMB_OMR-2 CMB_UTF-2 
         BTN_HAMT-2 BTN_KALK-2 BTN_UPP-2 BRW_URBER BRW_VBER TOG_BERNY BTN_LIST 
         BTN_SCHAKTP BTN_INK BTN_HAOF-2 BTN_AOF-2 BTN_GJORDABES BTN_ATG 
         ...
         FILL-IN-HBERNR FILL-IN_EAONR-2 FILL-IN_DELNR-2 BTN_BACK-2 BTN_AVB-2 
  ...
  ENABLE IMAGE-8 RECT-20 RECT-21 CMB_FAK-4 FILL-IN_PROJEKTKOD CMB_OMR-4 
         ...
         BRW_VFAKT BTN_Kred BTN_HAOF-4 BTN_PRELB BTN_ALLOVER-4 BTN_VISAO-2 
         BTN_UPP-4 BTN_VFAK BTN_FAK BTN_AONRM BTN_FLISTA BTN_ADM-3 BTN_OVER-4 
  ...
  ENABLE IMAGE-9 BTN_ALLOVER-3 BTN_ALLBACK-3 RECT-51 RECT-53 TOG_KALKAO 
         ...
         BTN_HAOF-3 BTN_AOF-3 BTN_KALK-3 BTN_SLAIHOP BTN_VISKAL BTN_JMFKALK 
         BTN_INAKTIV-2 BTN_ARENDESTATUS BTN_ADM-2 BTN_EKG BTN_NY-3 BTN_BORT-3 
  ...
  ENABLE MBTN_ANV MBTN_BEH MBTN_OVR RECT-MENY-2 RAD_VAL BTN_SKR-2 BTN_VIALLA 
  ...
  ENABLE MBTN_TILLAGG MBTN_TIDSEDEL MBTN_TJANSTERESA MBTN_TIDADM MBTN_FLEXADM 
         MBTN_STANSA BTN_PALLBACK IMAGE-14 BTN_PALLOVER RECT-S RECT-MENY-3 
         BTN_TID BTN_PBACK BTN_TBRES BTN_UTRES CMB_TARST CMB_TMANADST CMB_TARSL 
         CMB_TMANADSL RAD_TIDSVAL BTN_REG BTN_ARES BTN_NDA BTN_LON CMB_AR 
         CMB_MANAD FILL-IN_DATUM TOG_MAN CMB_TAR CMB_TMANAD BTN_FDA BTN_BER-8 
         BTN_GOD RAD_ALLVAL BTN_GRAN BTN_TRA BTN_KONT BRW_AVD BRW_VAVD 
         BTN_OVERT CMB_OMR-8 BTN_VISA-8 BRW_GODK BRW_ANSV BRW_PERS BRW_MARK 
         BTN_ARB BTN_LASUPPT BTN_VOVER BTN_ANDGOD BTN_VTIDV BTN_HAOF-8 BTN_LGOD 
         ...
         BTN_ALLBACK-8 BTN_KONTROLL BTN_FLKORN FILL-IN_SPERSONALKOD-8 
         FILL-IN_SFORNAMN-8 BTN_SALMAN FILL-IN_SEFTERNAMN-8 
         FILL-IN_EPERSONALKOD-8 FILL-IN-TDATUM-2 BTN_AVB-8 FILL-IN-TDAG-2 
         FILL-IN-TDAG FILL-IN_ETIDSGODK BTN_PVVOVER 
      WITH FRAME FRAME-TID IN WINDOW C-Win.
  ...
  DISPLAY TOG_GFARB1 TOG_GFARB2 TOG_GFARB3 ED_GFkomm TOG_GFARB4 TOG_GFARB5 
          TOG_GFARB6 FILL-IN-FRIFORSLAG TOG_E-3 TOG_E-19 TOG_E-16 TOG_E-7 
          TOG_E-17 TOG_E-8 TOG_E-6 TOG_E-4 TOG_E-30 TOG_E-20 TOG_E-21 TOG_E-22 
          TOG_E-23 TOG_E-24 TOG_E-25 TOG_E-26 TOG_E-27 TOG_E-28 TOG_E-15 
          TOG_E-11 TOG_E-14 TOG_E-13 TOG_E-12 TOG_E-5 TOG_E-29 TOG_E-9 TOG_E-10 
          TOG_E-18 TOG_E-1 TOG_E-2 TOG_V-10 TOG_V-15 TOG_V-19 TOG_V-11 TOG_V-4 
          TOG_V-2 TOG_V-5 TOG_V-3 TOG_V-13 TOG_V-6 TOG_V-7 TOG_V-8 TOG_V-9 
          TOG_V-30 TOG_V-23 TOG_V-18 TOG_V-22 TOG_V-24 TOG_V-12 TOG_V-26 
          TOG_V-29 TOG_V-14 TOG_V-25 TOG_V-16 TOG_V-17 TOG_V-21 TOG_V-20 
          TOG_V-27 TOG_V-28 TOG_V-1 FILL-IN-GFTEXT1 FILL-IN-GFTEXTS1-1 
          FILL-IN-GFTEXTS1-2 FILL-IN-GFTEXTS1-3 FILL-IN-GFTEXT2 FILL-IN-GFTEXT3 
          FILL-IN-GFTEXT4 FILL-IN-GFTEXT5 FILL-IN-R1 FILL-IN-R2 FILL-IN-R4 
          FILL-IN-R6 FILL-IN-FRO FILL-IN-R8 FILL-IN-F2 FILL-IN-F3 FILL-IN-F5 
          FILL-IN-F4 FILL-IN-F1 FILL-IN-F6 FILL-IN-R3 FILL-IN-R5 FILL-IN-R7 
          FILL-IN-R9 FILL-IN-FRO1 FILL-IN-FRO3 FILL-IN-FRO5 FILL-IN-FRO7 
          FILL-IN-FT5DEL2 FILL-IN-FT6DEL2 FILL-IN-FT3DEL2 FILL-IN-FT2DEL2 
          FILL-IN-FT1DEL2 FILL-IN-FT4DEL2 FILL-IN-FT1 FILL-IN-FT3 FILL-IN-FT6 
          FILL-IN-FT4 FILL-IN-FT2 FILL-IN-FT5 FILL-IN-GFKOM FILL-IN-FRO6 
          FILL-IN-FRO4 FILL-IN-FRO2 FILL-IN-V-5 FILL-IN-V-4 FILL-IN-V-3 
          FILL-IN-V-2 FILL-IN-V-1 FILL-IN-E-5 FILL-IN-E-4 FILL-IN-E-3 
          FILL-IN-E-2 FILL-IN-E-1 
      WITH FRAME FRAME-GURUFRAGOR IN WINDOW C-Win.
  ENABLE TOG_GFARB1 TOG_GFARB2 TOG_GFARB3 ED_GFkomm TOG_GFARB4 TOG_GFARB5 
         TOG_GFARB6 BTN_PREV BTN_NEXT FILL-IN-FRIFORSLAG TOG_E-3 TOG_E-19 
         TOG_E-16 TOG_E-7 TOG_E-17 TOG_E-8 TOG_E-6 TOG_E-4 TOG_E-30 TOG_E-20 
         TOG_E-21 TOG_E-22 TOG_E-23 TOG_E-24 TOG_E-25 TOG_E-26 TOG_E-27 
         TOG_E-28 TOG_E-15 TOG_E-11 TOG_E-14 TOG_E-13 TOG_E-12 TOG_E-5 TOG_E-29 
         TOG_E-9 TOG_E-10 TOG_E-18 TOG_E-1 TOG_E-2 TOG_V-10 TOG_V-15 TOG_V-19 
         TOG_V-11 TOG_V-4 TOG_V-2 TOG_V-5 TOG_V-3 TOG_V-13 TOG_V-6 TOG_V-7 
         TOG_V-8 TOG_V-9 TOG_V-30 TOG_V-23 TOG_V-18 TOG_V-22 TOG_V-24 TOG_V-12 
         TOG_V-26 TOG_V-29 TOG_V-14 TOG_V-25 TOG_V-16 TOG_V-17 TOG_V-21 
         TOG_V-20 TOG_V-27 TOG_V-28 TOG_V-1 FILL-IN-GFTEXT1 FILL-IN-GFTEXTS1-1 
         FILL-IN-GFTEXTS1-2 FILL-IN-GFTEXTS1-3 FILL-IN-GFTEXT2 FILL-IN-GFTEXT3 
         FILL-IN-GFTEXT4 FILL-IN-GFTEXT5 FILL-IN-R1 FILL-IN-R2 FILL-IN-R4 
         FILL-IN-R6 FILL-IN-FRO FILL-IN-R8 FILL-IN-R3 FILL-IN-R5 FILL-IN-R7 
         FILL-IN-R9 FILL-IN-FRO1 FILL-IN-FRO3 FILL-IN-FRO5 FILL-IN-FRO7 
         FILL-IN-FRO6 FILL-IN-FRO4 FILL-IN-FRO2 
      WITH FRAME FRAME-GURUFRAGOR IN WINDOW C-Win.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _PROCEDURE GuruFragor_UI C-Win 
PROCEDURE GuruFragor_UI :
/*------------------------------------------------------------------------------
  Purpose:     
  Parameters:  <none>
  Notes:       
------------------------------------------------------------------------------*/
   DEFINE VARIABLE ingaposter AS LOGICAL NO-UNDO.
   FRAME FRAME-GURUFRAGOR:WIDTH = IMAGE-5h:WIDTH - CMB_MANh:WIDTH.
   FRAME FRAME-GURUFRAGOR:HEIGHT = IMAGE-5h:HEIGHT - (CMB_MANh:ROW + 2).
   IF NOT VALID-HANDLE(gurufragah) THEN DO:
     /* FRAME FRAME-GURUFRAGOR:HIDDEN = FALSE.*/
      EMPTY TEMP-TABLE whandltemp NO-ERROR.
      ordningnr = 1.
      CREATE whandltemp.
      RUN whandle_UI (INPUT-OUTPUT ordningnr, C-WIN:HANDLE).
      ...
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-F3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-F4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-F5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-F6:HANDLE IN FRAME FRAME-GURUFRAGOR). 
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT6:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT1DEL2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT2DEL2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT3DEL2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT4DEL2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT5DEL2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FT6DEL2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      ...
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-GFTEXTS1-1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-GFTEXTS1-2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-GFTEXTS1-3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      ...
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO6:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-FRO7:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-6:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-7:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-8:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-9:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-10:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-11:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-12:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-13:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-14:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-15:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-16:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-17:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-18:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-19:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-20:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-21:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-22:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-23:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-24:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-25:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-26:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-27:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-28:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-29:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_V-30:HANDLE IN FRAME FRAME-GURUFRAGOR).
      
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-6:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-7:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-8:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-9:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-10:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-11:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-12:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-13:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-14:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-15:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-16:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-17:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-18:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-19:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-20:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-21:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-22:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-23:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-24:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-25:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-26:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-27:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-28:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-29:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, TOG_E-30:HANDLE IN FRAME FRAME-GURUFRAGOR).
      
      
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-V-1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-V-2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-V-3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-V-4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-V-5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-E-1:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-E-2:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-E-3:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-E-4:HANDLE IN FRAME FRAME-GURUFRAGOR).
      RUN whandle_UI (INPUT-OUTPUT ordningnr, FILL-IN-E-5:HANDLE IN FRAME FRAME-GURUFRAGOR).
      
      RUN GURUFRAGOR.P PERSISTENT SET gurufragah (INPUT THIS-PROCEDURE ,INPUT framesizeh,INPUT multitriggh,INPUT TABLE whandltemp,INPUT-OUTPUT ingaposter).
      IF ingaposter = TRUE THEN RETURN.
   END.
    
   RUN infimage_UI IN gurufragah.
   RUN PlaceraFrame_UI IN gurufragah.   
...
------------------------------------------------------------------------------*/
   ...
   RUN blobfilC_UI IN blobproch (INPUT blobname, OUTPUT resid,OUTPUT BlobKommandout).   
   IF resid = ? THEN DO:                 
...
------------------------------------------------------------------------------*/
   ...
   DEFINE VARIABLE kommando AS CHARACTER NO-UNDO.   
   RUN DYNBLOBB.P PERSISTENT SET blobproch.    
   RUN blobfilC_UI IN blobproch (INPUT imptemp.FILNAMN, OUTPUT resid,OUTPUT BlobKommandout).   
   IF resid = ? THEN DO:                 
