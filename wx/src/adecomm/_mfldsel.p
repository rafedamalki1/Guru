...
/*
p_TblList -> list of dbname.tables that should be viewed in list 1
...
/* Dummy code for testing (if you are hooked to the demo database).
DEFINE VAR p_TblLst AS CHARACTER INITIAL "Customer" NO-UNDO.
