...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Felmeddelande */
DO:
   musz = TRUE.
...
ON CHOOSE OF BTN_KLAR IN FRAME Dialog-Frame /* Avsluta */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   IF varifran = 1 THEN DO:
      FILL-IN-TEXT1 = "Du är utanför flexramen!".
      FILL-IN-TEXT2 = "Använd knappen Flex IN istället!".      
   END.
   ELSE IF varifran = 2 THEN DO:
      FILL-IN-TEXT1 = "Du är utanför flexramen!".
      FILL-IN-TEXT2 = "Använd knappen Flex UT istället!".
   END.
   RUN enable_UI.       
   {FRMSIZED.I}
...
END.
ELSE MESSAGE "felknapp.wrx":U SKIP(1)
