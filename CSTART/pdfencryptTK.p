...
&GLOBAL-DEFINE MD5LIB  md5.exe  /* Vart ligger den här ? */
...
PROCEDURE DetermineOwnerKey:
  ...
  ASSIGN L_TxtFile = ".\" + p_UniqueID + "-O.txt"
         L_md5File = ".\" + p_UniqueID + "-O.md5".
...
PROCEDURE DetermineUserKey:
  ...
  ASSIGN L_TxtFile = ".\" + p_UniqueID + "-U.txt"
         L_md5File = ".\" + p_UniqueID + "-U.md5".
...
PROCEDURE GetEncryptKey:
  ...
  ASSIGN L_TxtFile = ".\" + p_UniqueID + "-key.txt"
         L_md5File = ".\" + p_UniqueID + "-key.md5".
...
PROCEDURE BuildDocId:
  ...
  ASSIGN L_TxtFile = ".\" + pUniqueID + "-ID.txt"
         L_md5File = ".\" + pUniqueID + "-ID.md5".
