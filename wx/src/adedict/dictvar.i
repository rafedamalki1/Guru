...
/* Gray_Items:
   ...
   that need graying. 
*/
&global-define  NUM_GRAY_ITEMS   32
...
/* These are used to manipulate work files - used to save property info
   in case the user doesn't save property changes. */
&global-define 	  MAIN_TO_WORK	    1
&global-define    TRIGS_TO_WORK	    2
&global-define    GATE_TO_WORK	    3
&global-define    CMP_WORK    	    4
&global-define    ALL_FROM_WORK	    5
------------------------------------------------------------------*/
