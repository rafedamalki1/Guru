/*TEJKSAL.P  UPPDATERAR FLEXSALDO MED EJ KORD FLEXTID tidpers*/ 
...
FLEXDAG.KONTROLL = "KONTROLL" USE-INDEX KONTROLL NO-LOCK.
GET FIRST flsal NO-LOCK.
DO WHILE AVAILABLE(FLEXDAG):  
   IF YEAR(FLEXDAG.DATUM) = YEAR(TODAY) AND MONTH(FLEXDAG.DATUM) > MONTH(TODAY) THEN nytid = nytid.
   ELSE DO:
      CREATE fldag.
      ASSIGN          
