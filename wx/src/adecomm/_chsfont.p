...
/*************************************************************/
/* $Id: _chsfont.p,v 1.19 97/01/24 18:25:47 ross Exp $ */
...
PROCEDURE EditFont.
  ...
  IF iipFontNumber > -1 AND iipFontNumber < 256 THEN DO:
    /* Change cursor to wait (mostly this is important under Motif where the
       SYSTEM-DIALOG takes 5 seconds to load).  The dialog will set the pointer
       back */
