/*
     Filename: XKTESTMAPI.P
     Comment: Tar emot subject(char), body(char), bifogadfil(char, fullständig sökväg, ex c:\protemp9\test.txt)
...
PROCEDURE MAPI :
   ...
   NoOfRecipients = NUM-ENTRIES("" ,{&SEMI-COLON}) +
   NUM-ENTRIES("",{&SEMI-COLON}) +
   NUM-ENTRIES("" ,{&SEMI-COLON}).
