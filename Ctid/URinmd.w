...
&Scoped-Define ENABLED-OBJECTS FBTN_REG BTN_UPP BTN_BYT BTN_UPPD BTN_AVB 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW_RESA-2 DIALOG-1 _STRUCTURED
  QUERY BRW_RESA-2 NO-LOCK DISPLAY
      ...
      respers.AONR COLUMN-LABEL "Aonr" FORMAT "X(6)":U
...
DEFINE FRAME DIALOG-1
     FILL-IN-PKOD AT ROW 4.67 COL 12.13 COLON-ALIGNED
     FILL-IN_FORNAMN-2 AT ROW 4.67 COL 22.13 COLON-ALIGNED NO-LABEL
     BRW_RESA-2 AT ROW 6.04 COL 1.5
     FBTN_REG AT ROW 8 COL 77.75
     BTN_KOMP AT ROW 9.08 COL 77.75
     BTN_UPP AT ROW 19.67 COL 16
     BTN_BYT AT ROW 19.67 COL 33.25
     BTN_UPPD AT ROW 19.67 COL 50.5
     BTN_AVB AT ROW 19.67 COL 77.75
     "OBS! Vid utlandsresa erhålles enbart restid till/ från gränsen till Sverige." VIEW-AS TEXT
          SIZE 76.63 BY .67 AT ROW 2.88 COL 1.5
     "Restid till utlandet" VIEW-AS TEXT
          SIZE 37 BY 1.5 AT ROW 1.17 COL 1.5
          FONT 17
     "Endast restid utanför ordinarie arbetstid skall registreras." VIEW-AS TEXT
          SIZE 62.75 BY .75 AT ROW 3.71 COL 1.5
     SPACE(28.74) SKIP(16.36)
...
/* SETTINGS FOR BUTTON BTN_KOMP IN FRAME DIALOG-1
   NO-ENABLE                                                            */
ASSIGN 
       BTN_KOMP:HIDDEN IN FRAME DIALOG-1           = TRUE.
...
"respers.AONR" "Aonr" ? "character" ? ? ? ? ? ? yes ? no no ? yes no no "U" "" ""
...
DO:
   ...
   MESSAGE "Vill du avbryta utan att spara något ?" 
...
&Scoped-define SELF-NAME BTN_KOMP
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BTN_KOMP DIALOG-1
ON CHOOSE OF BTN_KOMP IN FRAME DIALOG-1 /* Komplettera */
DO:
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   respers.KILOMETER:LABEL = "Används!ej".
   respers.KILOMETER:READ-ONLY IN BROWSE {&BROWSE-NAME} = TRUE.
   ...
   IF enflerdygns = TRUE THEN DO:
      ...
      IF sok2 = 1 THEN DO:
         ASSIGN         
         respers.BILFORARE:READ-ONLY IN BROWSE {&BROWSE-NAME} = TRUE.
      END.      
   END.   
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-PKOD FILL-IN_FORNAMN-2 
      WITH FRAME DIALOG-1.
  ENABLE FBTN_REG BTN_UPP BTN_BYT BTN_UPPD BTN_AVB 
      WITH FRAME DIALOG-1.
...
------------------------------------------------------------------------------*/
   DISPLAY
   respers.AONR respers.BILFORARE respers.DELNR respers.Kilometer respers.SLUT respers.START   
