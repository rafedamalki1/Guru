...
ELSE IF Guru.Konstanter:globforetag = "ELPA" THEN prognamn5 = "\\pc112\delad\pro9s\".         

/*IF Guru.Konstanter:globforetag = "lule" OR Guru.Konstanter:globforetag = "ELPA" THEN DO:
   prognamn3 = prognamn5 + "filfore.d".
      ...
      IF AVAILABLE ANSTFORMTAB THEN DO:
         ...
         IF Guru.Konstanter:globforetag = "LULE" THEN DO:   
            IF TODAY < 05/01/2005 THEN DO:      
                ...
                TIDREGITAB.DATUM > 03/31/2005 AND TIDREGITAB.DATUM <= vkdatum USE-INDEX PSTART NO-LOCK. 
            END.
            ELSE DO:
               OPEN QUERY tidq FOR EACH TIDREGITAB WHERE
               TIDREGITAB.PERSONALKOD = PERSONALTAB.PERSONALKOD AND
         ...
         IF Guru.Konstanter:globforetag = "ELPA" THEN DO:   
            ...
            TIDREGITAB.GODKAND BEGINS "G" AND
            SUBSTRING(TIDREGITAB.VECKOKORD,1,9) NE "" AND SUBSTRING(TIDREGITAB.VECKOKORD,10,9) = korvar AND
            TIDREGITAB.DATUM > 12/31/2004 AND TIDREGITAB.DATUM <= vkdatum USE-INDEX PSTART NO-LOCK. 
         END.
...
END.
IF Guru.Konstanter:globforetag = "lule" OR Guru.Konstanter:globforetag = "ELPA" THEN DO:
   prognamn3 = prognamn5 + "filefter1.d".
   OUTPUT TO VALUE(prognamn3).          
   /*OUTPUT TO d:\elpool\DELAD\PRO9S\EXPORT\lon\filefter.d.*/
   FOR EACH pa90fil:
     EXPORT pa90fil.
   END.
END.
...
END.
IF Guru.Konstanter:globforetag = "lule" OR Guru.Konstanter:globforetag = "ELPA" THEN DO:   
   prognamn3 = prognamn5 + "filefter2.d".
   OUTPUT TO VALUE(prognamn3).          
   /*OUTPUT TO d:\elpool\DELAD\PRO9S\EXPORT\lon\filefter.d.*/
   FOR EACH pa90fil:
     EXPORT pa90fil.
...
RUN LULEVE2.P.      /* summerar veckans skörd till tidigare */
