...
/* may be  reproduced in  any form  or by  any means without RF*/
...
FORM SKIP(1)
  ...
  ROW 6 width &IF "{&WINDOW-SYSTEM}" BEGINS "MS-WIN" &THEN 70 &ELSE 55 &ENDIF
...
IF DBTYPE("DICTDB") = "PROGRESS" AND DBVERSION("DICTDB") < "8" THEN
  DELETE ALIAS "DICTDB".
