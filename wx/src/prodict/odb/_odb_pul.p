...
/*
define TEMP-TABLE w_idx-pick no-undo
          FIELD name             as character
          FIELD dtype#           as integer
          FIELD fld#             as integer
          FIELD fstoff           as integer
          FIELD level            as integer
          FIELD mand             as logical
          FIELD misc23           as character
          FIELD slctd            as logical
          INDEX upi        IS UNIQUE PRIMARY name
          INDEX pick                         dtype# fld#.   
*/
    ...
    */
    ...
    for each DICTDBG.SQLColumns_buffer:
      ...
      find first column-id
           where column-id.col-name = TRIM(DICTDBG.SQLColumns_buffer.column-name).
    ...
    if s_ttb_tbl.ds_recid > 0 and not has_id_ix
