...
PROCEDURE MAPI :
   ...
   DEFINE INPUT PARAMETER Bodytext2    AS CHARACTER.
   DEFINE INPUT PARAMETER FilePathName AS CHARACTER. 
   DEFINE INPUT PARAMETER FilePathName2 AS CHARACTER. 
   ...
   DEFINE VARIABLE TextPtr2 AS MEMPTR.
   SET-SIZE(TextPtr2) = 60000. 
   PUT-STRING(TextPtr2,1) = Bodytext2 + (IF FilePathName = "":U 
                                    THEN "":U 
                                    ELSE CHR(10) + CHR(10) + " ":U).   
   ...
   PUT-LONG(MessageDescPtr,13) = GET-POINTER-VALUE(TextPtr2).  /* Text */
   PUT-LONG(MessageDescPtr,17) = 0. /* MessageType */ 
   PUT-LONG(MessageDescPtr,21) = 0. /* DateReceived */ 
   PUT-LONG(MessageDescPtr,25) = 0. /* ConversationID */ 
   PUT-LONG(MessageDescPtr,29) = 1.  /* Flags */
   PUT-LONG(MessageDescPtr,33) = GET-POINTER-VALUE(OriginDescPtr).  /* Originator */
   PUT-LONG(MessageDescPtr,37) = 1.  /* RecipCount */
   PUT-LONG(MessageDescPtr,41) = GET-POINTER-VALUE(RecipDescPtr).  /* Recips */
   PUT-LONG(MessageDescPtr,45) = (IF FilePathName = "":U 
                                     THEN 0 
                                     ELSE 1).  /* FileCount */
   PUT-LONG(MessageDescPtr,47) = (IF FilePathName = "":U 
                                     THEN 0 
