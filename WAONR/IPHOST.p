/*IPHOST.P
programmet skickar ut ipnummer och datornamn*/
...
DEFINE OUTPUT PARAMETER ipvar AS CHARACTER NO-UNDO.
DEFINE OUTPUT PARAMETER datorvar AS CHARACTER NO-UNDO.
                    
RUN I-GetTcpInfo (OUTPUT datorvar, OUTPUT ipvar). 
