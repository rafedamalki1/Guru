...
konstgrptemp.UNAMN konstgrptemp.KONSTGRPLAST 
&Scoped-define ENABLED-FIELDS-IN-QUERY-BRW_GRUPP konstgrptemp.KONSTGRPLAST 
&Scoped-define ENABLED-TABLES-IN-QUERY-BRW_GRUPP konstgrptemp
&Scoped-define FIRST-ENABLED-TABLE-IN-QUERY-BRW_GRUPP konstgrptemp
...
&Scoped-define List-1 BTN_NY-3 BTN_AND-4 BTN_BORT-3 BTN_NY-4 BTN_AND-5 ~
BTN_BORT-4 BTN_KOPIERKONST-2 BTN_BILD-2 BTN_VPER-2 BTN_OK-2 BTN_BILD-3 
&Scoped-define List-2 BTN_SKAPA btn_uppant 
&Scoped-define List-3 FBTN_SKAPAFLERA2 
&Scoped-define List-4 BTN_NY-2 BTN_AND1 BTN_AND-3 BTN_BORT-2 BTN_ANDANT ~
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW_GRUPP C-Win _STRUCTURED
  QUERY BRW_GRUPP NO-LOCK DISPLAY
      konstgrptemp.BENAMNING FORMAT "X(256)":U WIDTH 28
      konstgrptemp.UNAMN COLUMN-LABEL "Ersättningslista" FORMAT "x(30)":U
            WIDTH 15
      konstgrptemp.KONSTGRPLAST COLUMN-LABEL "Låst" FORMAT "Ja/Nej":U
            WIDTH 3 VIEW-AS TOGGLE-BOX
  ENABLE
      konstgrptemp.KONSTGRPLAST
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-COLUMN-SCROLLING SIZE 48.75 BY 23.25 FIT-LAST-COLUMN.
...
DEFINE FRAME FRAME-BARABREDD
     ...
     FBTN_HAMTA AT ROW 8 COL 117.75
     FBTN_ANDRA2 AT ROW 9.13 COL 117.75
     FBTN_ATER AT ROW 9.25 COL 118.25 WIDGET-ID 4
     FBTN_SKAPAFLERA2 AT ROW 10.25 COL 117.75 WIDGET-ID 2
     BTN_AVB AT ROW 28.17 COL 118.25
     RECT-MENY AT ROW 3.38 COL 1
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 131.88 BY 28.38.
...
DEFINE FRAME FRAME-KONSTGRP
     ...
     BTN_UPP AT ROW 11.04 COL 112.63
     BTN_NER AT ROW 13.88 COL 112.63
...
DEFINE FRAME FRAME-VMTRL
     ...
     img_locked2 AT ROW 1.13 COL 30.63 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 3.5
         SIZE 110 BY 25.8.
...
DEFINE FRAME FRAME-KONST
     ...
     "Konstruktioner" VIEW-AS TEXT
          ...
          FONT 17
     img_locked AT ROW 3.17 COL 30.5 WIDGET-ID 2
    WITH 1 DOWN NO-BOX KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 3.48
         SIZE 109.5 BY 25.8.
...
/* SETTINGS FOR BUTTON BTN_AND-3 IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
/* SETTINGS FOR BUTTON BTN_AND1 IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
/* SETTINGS FOR BUTTON BTN_ANDANT IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
/* SETTINGS FOR BUTTON BTN_ANDLIN IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
/* SETTINGS FOR BUTTON BTN_ANDMOD IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
ASSIGN 
       BTN_ANDMOD:HIDDEN IN FRAME FRAME-ANDRAMTRL           = TRUE.

/* SETTINGS FOR BUTTON BTN_BORT-2 IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
/* SETTINGS FOR BUTTON BTN_NY-2 IN FRAME FRAME-ANDRAMTRL
   4                                                                    */
/* SETTINGS FOR FRAME FRAME-BARABREDD
                                                                        */
/* SETTINGS FOR BUTTON FBTN_SKAPAFLERA2 IN FRAME FRAME-BARABREDD
   3                                                                    */
ASSIGN 
...
/* SETTINGS FOR BUTTON BTN_AND-4 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_AND-5 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_BILD-2 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_BILD-3 IN FRAME FRAME-KONST
   1                                                                    */
ASSIGN 
       BTN_BILD-3:HIDDEN IN FRAME FRAME-KONST           = TRUE.

/* SETTINGS FOR BUTTON BTN_BORT-3 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_BORT-4 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_KOPIERKONST-2 IN FRAME FRAME-KONST
   1                                                                    */
ASSIGN 
...
/* SETTINGS FOR BUTTON BTN_NY-3 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_NY-4 IN FRAME FRAME-KONST
   1                                                                    */
/* SETTINGS FOR BUTTON BTN_OK-2 IN FRAME FRAME-KONST
   1                                                                    */
ASSIGN 
...
/* SETTINGS FOR BUTTON BTN_VPER-2 IN FRAME FRAME-KONST
   1                                                                    */
...
/* SETTINGS FOR IMAGE img_locked IN FRAME FRAME-KONST
   NO-ENABLE                                                            */
...
/* SETTINGS FOR FRAME FRAME-VMTRL
                                                                        */
/* BROWSE-TAB BRW_KON2 CMB_VAL FRAME-VMTRL */
...
/* BROWSE-TAB BRW_SATS BRW_B6 FRAME-VMTRL */
/* BROWSE-TAB BRW_SOKMTRLF BRW_SATS FRAME-VMTRL */
/* BROWSE-TAB BRW_HLEV BRW_SOKMTRLF FRAME-VMTRL */
/* BROWSE-TAB BRW_MTRL BRW_HLEV FRAME-VMTRL */
ASSIGN 
...
/* SETTINGS FOR BUTTON BTN_SKAPA IN FRAME FRAME-VMTRL
   2                                                                    */
...
/* SETTINGS FOR BUTTON btn_uppant IN FRAME FRAME-VMTRL
   2                                                                    */
...
/* SETTINGS FOR IMAGE img_locked2 IN FRAME FRAME-VMTRL
   NO-ENABLE                                                            */
...
"BENAMNING" ? "X(256)" "character" ? ? ? ? ? ? no ? no no "28" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[2]   > Temp-Tables.konstgrptemp.UNAMN
"UNAMN" "Ersättningslista" "x(30)" "character" ? ? ? ? ? ? no ? no no "15" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _FldNameList[3]   > Temp-Tables.konstgrptemp.KONSTGRPLAST
"KONSTGRPLAST" "Låst" "Ja/Nej" "logical" ? ? ? ? ? ? yes ? no no "3" yes no no "U" "" "" "TOGGLE-BOX" "," ? ? 5 no 0 no no
     _Query            is NOT OPENED
*/  /* BROWSE BRW_GRUPP */
&ANALYZE-RESUME
...
&Scoped-define SELF-NAME konstgrptemp.KONSTGRPLAST
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL konstgrptemp.KONSTGRPLAST BRW_GRUPP _BROWSE-COLUMN C-Win
ON VALUE-CHANGED OF konstgrptemp.KONSTGRPLAST IN BROWSE BRW_GRUPP /* Låst */
DO:    
   IF konstgrptemp.KONSTGRPLAST:SCREEN-VALUE IN BROWSE BRW_GRUPP = ? THEN. 
   ELSE konstgrptemp.KONSTGRPLAST = LOGICAL((konstgrptemp.KONSTGRPLAST:SCREEN-VALUE IN BROWSE BRW_GRUPP), "Ja/Nej").
      
   RUN sparalast_UI IN konmtrlapph (INPUT konstgrptemp.KONSKOD,INPUT konstgrptemp.KONSTGRPLAST).   
END.
...
-------------------------------------------------------------*/ 
   ...
   IF Guru.Konstanter:globnetprissortvar = 1 THEN  RUN setcolindex_UI IN brwproc[7] (INPUT "kund DESCENDING by enr").       
...
-------------------------------------------------------------*/
   ...
   CMB_LEV:SCREEN-VALUE = Guru.Konstanter:HuvudLeverantorName
...
------------------------------------------------------------------------------*/
   ...
   IF AVAILABLE konstgrptemp THEN DO:
      kongrkod = konstgrptemp.KONSKOD.
      IF konstgrptemp.KONSTGRPLAST = TRUE THEN DO:
         DISABLE {&LIST-1} WITH FRAME {&FRAME-NAME}.
         /* Kolla låset på konstgruppen och ev disabla menypunkten på konval */
         RUN disablemenuitem_UI IN brwproc[14] (INPUT BRW_VAL:HANDLE,INPUT "Klistra in undergrupp i Konstruktion").
         /* Hänglås på */
         IMG_LOCKED:LOAD-IMAGE("BILDER\locked.gif") IN FRAME {&FRAME-NAME} no-error.         
      END.
      ELSE DO:
         ENABLE UNLESS-HIDDEN {&LIST-1} WITH FRAME {&FRAME-NAME}.         
         RUN enablemenuitem_UI IN brwproc[14] (INPUT BRW_VAL:HANDLE,INPUT "Klistra in undergrupp i Konstruktion").
         /* Hänglås av */
         IMG_LOCKED:LOAD-IMAGE(?) IN FRAME {&FRAME-NAME} no-error.
      END.     
...
------------------------------------------------------------------------------*/
   ...
   IF konstgrptemp.KONSTGRPLAST = TRUE THEN DO:
      DISABLE {&LIST-2} WITH FRAME FRAME-VMTRL.
      DISABLE {&LIST-3} WITH FRAME FRAME-BARABREDD.
      DISABLE {&LIST-4} WITH FRAME FRAME-ANDRAMTRL. 
      /* Kolla låset på konstgruppen och ev disabla menypunkten på konval2 */
         RUN disablemenuitem_UI IN brwproc[8] (INPUT BRW_KON2:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
         RUN disablemenuitem_UI IN brwproc[2] (INPUT BRW_B2:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
         RUN disablemenuitem_UI IN brwproc[3] (INPUT BRW_B3:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
         RUN disablemenuitem_UI IN brwproc[4] (INPUT BRW_B4:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
         RUN disablemenuitem_UI IN brwproc[5] (INPUT BRW_B5:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
         RUN disablemenuitem_UI IN brwproc[6] (INPUT BRW_B6:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
      /* Hänglås på */
      IMG_LOCKED2:LOAD-IMAGE("BILDER\locked.gif") IN FRAME {&FRAME-NAME} no-error.        
   END.
   ELSE DO:
      ENABLE UNLESS-HIDDEN {&LIST-2} WITH FRAME FRAME-VMTRL. 
      ENABLE UNLESS-HIDDEN {&LIST-3} WITH FRAME FRAME-BARABREDD.
      ENABLE UNLESS-HIDDEN {&LIST-4} WITH FRAME FRAME-ANDRAMTRL. 
      RUN enablemenuitem_UI IN brwproc[8] (INPUT BRW_KON2:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
      RUN enablemenuitem_UI IN brwproc[2] (INPUT BRW_B2:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
      RUN enablemenuitem_UI IN brwproc[3] (INPUT BRW_B3:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
      RUN enablemenuitem_UI IN brwproc[4] (INPUT BRW_B4:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
      RUN enablemenuitem_UI IN brwproc[5] (INPUT BRW_B5:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").
      RUN enablemenuitem_UI IN brwproc[6] (INPUT BRW_B6:HANDLE,INPUT "Import Excel - enr i första kolumn antal i andra kolumn leverantör i tredje kolumn(blank = vald leverantör beredning)").       
      /* Hänglås av */
      IMG_LOCKED2:LOAD-IMAGE(?) IN FRAME {&FRAME-NAME} no-error.
   END.    
...
------------------------------------------------------------------------------*/
  ENABLE MBTN_KONSTGRP RECT-MENY MBTN_KONST MBTN_KONSTMTRL MBTN_KONSTKALK 
         MBTN_MADM FBTN_HAMTA FBTN_ANDRA2 FBTN_ATER FBTN_SKAPAFLERA2 BTN_AVB 
  ...
  ENABLE RECT-22 IMAGE-7 CMB_VAL BRW_KON2 BRW_B2 BRW_B3 BRW_B4 BRW_B5 BRW_B6 
         BRW_SATS BRW_SOKMTRLF BRW_HLEV BRW_MTRL BTN_LEV CMB_LEV BTN_SKAPA 
         BTN_RENSA BTN_SATS BTN_MOD FILL-IN-ENR FILL-IN-KOD FILL-IN-BEN 
...
-------------------------------------------------------------*/      
   ...
   RUN title_UI.
   FRAME FRAME-ANDRAMTRL:HIDDEN = TRUE. 
   IF konstgrptemp.KONSTGRPLAST = FALSE THEN                    
...
-------------------------------------------------------------*/       
   ...
   status-ok = SEL_UPP:ADD-LAST("Kalkylkoder som ej finns i kostnadskatalogen-Uppdatera benämningar från senaste katalog") IN FRAME {&FRAME-NAME}.   
...
DEFINE VARIABLE bloblog AS LOGICAL NO-UNDO.
   ...
   ELSE IF SEL_UPP = "Kalkylkoder som ej finns i kostnadskatalogen-Uppdatera benämningar från senaste katalog" THEN RUN KALKKOLLU2.W.      
   ...
   IF Guru.Konstanter:AppSpringSet[1] = "ONENO" OR Guru.Konstanter:AppSpringSet[1] = "ONENOUTBI" THEN DO:
      IF SEL_UPP = "IFS AONR" THEN DO:
         ...
         END.  
      END.
      /*Anders Olsson Elpool i Umeå AB  1 nov 2022 10:11:31 
      nu mera via odbc 
