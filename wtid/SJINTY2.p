...
FIND TIDREGITAB WHERE TIDREGITAB.PERSONALKOD = PERSONALTAB.PERSONALKOD AND TIDREGITAB.DATUM = hjdatum AND
TIDREGITAB.AONR = "110" AND TIDREGITAB.TIDLOG = TRUE NO-LOCK NO-ERROR.
...
END.
PROCEDURE medd_UI:    
   DEFINE INPUT PARAMETER innandat AS DATE NO-UNDO.
   ...
   IF AVAILABLE persbuff THEN DO:   
      ...
      FIND FIRST MEDDELANDE WHERE MEDDELANDE.SANDARE = "Sjukintyg" AND MEDDELANDE.MOTTAGARE = ANVANDARE.ANVANDARE AND MEDDELANDE.MEDD = PERSONALTAB.PERSONALKOD + " " +  "har registrerat sjukdom från " + STRING(innandat,("9999/99/99")) + " till " + STRING(stdatum,("9999/99/99")) +  CHR(10)    NO-LOCK NO-ERROR.
      IF NOT AVAILABLE MEDDELANDE  THEN DO:      
         ...
         MEDDELANDE.MEDD = PERSONALTAB.PERSONALKOD + " " +  "har registrerat sjukdom från " + STRING(innandat,("9999/99/99")) + " till " + STRING(stdatum,("9999/99/99")) +  CHR(10).   
      END.
   END.
END PROCEDURE.
