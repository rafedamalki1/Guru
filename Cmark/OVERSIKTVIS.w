...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  IF AVAILABLE markval THEN DO:                       
     ...
     RUN vartal_UI IN skprotapph (INPUT markval.VARDNR, OUTPUT vartal).        
  ...
  FOR EACH markval BY markval.BETECKNING:
      IF markval.BETECKNING NE fbet THEN DO:
         ...
         IF AVAILABLE sumtemp THEN DO:
            ...
            MUAtemp.GRUNDERS = MUAtemp.GRUNDERS + sumtemp.GRUNDERS.                
            ...
            MUAtemp.REVERS = MUAtemp.REVERS + sumtemp.REVERS.
            MUAtemp.REVFB = MUAtemp.REVFB + sumtemp.REVFB.
            MUAtemp.REVSUM = MUAtemp.REVSUM + sumtemp.REVSUM.
  ...
  FOR EACH markval BY markval.BETECKNING:
     FIND FIRST MUAtemp WHERE MUAtemp.BETECKNING = markval.BETECKNING NO-LOCK NO-ERROR.    
      ...
      IF AVAILABLE extradatatemp THEN DO:      
         ...
         MUAtemp.M = extradatatemp.SOKLOG[3]
