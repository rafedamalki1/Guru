...
define variable l_msg as character no-undo extent 6 initial [
  /* 1*/ "You have been automatically switched to database",
  /* 2*/ "There is no V8 database connected. This tool cannot",
  /* 3*/ "be used with a PROGRESS V5, V6 or V7 database. Use the",
  /* 4*/ "tool under PROGRESS V5, V6 or V7 to access such a database",
  /* 5*/ ""
  ].
...
/* reset aliases, cache_dirty and user_filename */
  ...
  if   user_dbtype        = ""
   then do:
    message l_msg[2] skip
            l_msg[3] skip
            l_msg[4]
            view-as alert-box. /* no V8 db available */
   end.
