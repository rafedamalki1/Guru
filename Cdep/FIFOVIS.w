...
{WHANDLTEMP.I}
 ...
 DEFINE TEMP-TABLE fifotmp NO-UNDO
   ...
   FIELD datum AS DATE
   FIELD klockslag AS CHARACTER 
   FIELD DEPA AS INTEGER 
   INDEX enr enr.
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Alla Fifo-poster i lager"
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   FOR EACH extradatatemp NO-LOCK /*BY extradatatemp.SOKDATE[1] BY extradatatemp.SOKINT[2]*/ :
      CREATE fifotmp.
      ASSIGN
      fifotmp.enr =  extradatatemp.HUVUDCH
      fifotmp.ben = extradatatemp.SOKCHAR[2]
      fifotmp.enhet = extradatatemp.SOKCHAR[3]
      fifotmp.pris = extradatatemp.SOKDEC[1]
      fifotmp.antal = extradatatemp.SOKINT[1]
      fifotmp.datum = extradatatemp.SOKDATE[1]
      fifotmp.klockslag = STRING(extradatatemp.SOKINT[2],"HH:MM:SS") 
      fifotmp.depa = vald_depa.      
   END.
   ...
   RUN FIFOVISDYN.P PERSISTENT SET bestdynh (INPUT THIS-PROCEDURE, INPUT FRAME Dialog-FRAME:HANDLE,INPUT TABLE whandltemp).
   RUN skapabrw_UI IN bestdynh (INPUT 1, TEMP-TABLE fifotmp:DEFAULT-BUFFER-HANDLE).
