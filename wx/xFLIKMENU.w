...
&Scoped-Define ENABLED-OBJECTS BTN_BER RECT-10 BTN_KOPP BTN_LINA BTN_TRAFO ~
BTN_UPP 
...
DEFINE FRAME DEFAULT-FRAME
     BTN_BER AT ROW 1.71 COL 45.5
     BUTTON-18 AT ROW 1.71 COL 2.5 RIGHT-ALIGNED
     BUTTON-17 AT ROW 1.71 COL 73.5
     BTN_KOPP AT ROW 1.71 COL 3.5
     BTN_LINA AT ROW 1.71 COL 31.5
     BTN_TRAFO AT ROW 1.71 COL 17.5
     BTN_UPP AT ROW 1.71 COL 72.5 RIGHT-ALIGNED
     RECT-10 AT ROW 1.58 COL 1
...
/* SETTINGS FOR BUTTON BTN_UPP IN FRAME DEFAULT-FRAME
   ALIGN-R                                                              */
/* SETTINGS FOR BUTTON BUTTON-17 IN FRAME DEFAULT-FRAME
   NO-ENABLE                                                            */
/* SETTINGS FOR BUTTON BUTTON-18 IN FRAME DEFAULT-FRAME
   NO-ENABLE ALIGN-R                                                    */
...
/* SETTINGS FOR FRAME FRAME-E
                                                                        */
/* BROWSE-TAB BROWSE-7 TEXT-1 FRAME-E */
ASSIGN 
...
ON CHOOSE OF BTN_BER IN FRAME DEFAULT-FRAME
DO:
   BTN_BER:LOAD-IMAGE ("bilder\flik3.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
   RUN goma_UI (INPUT 4).   
END.
...
ON CHOOSE OF BTN_KOPP IN FRAME DEFAULT-FRAME
DO:
   BTN_KOPP:LOAD-IMAGE ("bilder\flik3.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
   RUN goma_UI (INPUT 1).  
END.
...
ON CHOOSE OF BTN_LINA IN FRAME DEFAULT-FRAME
DO:
   BTN_LINA:LOAD-IMAGE ("bilder\flik3.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
   RUN goma_UI (INPUT 3).
END.
...
ON CHOOSE OF BTN_TRAFO IN FRAME DEFAULT-FRAME
DO:
   BTN_TRAFO:LOAD-IMAGE ("bilder\flik3.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
   RUN goma_UI (INPUT 2).  
END.
...
ON CHOOSE OF BTN_UPP IN FRAME DEFAULT-FRAME
DO:
   BTN_UPP:LOAD-IMAGE ("bilder\flik3.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
   RUN goma_UI (INPUT 5).
END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   &Scoped-define FRAME-NAME DEFAULT-FRAME
   BTN_KOPP:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
   BTN_KOPP:LOAD-IMAGE-DOWN ("bilder\flik3.gif") IN FRAME {&FRAME-NAME}.
/*    BTN_KOPP:LOAD-IMAGE-DOWN ("BILDER\btn_tidsedel_over.gif") IN FRAME {&FRAME-NAME}. */
   BTN_TRAFO:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
   BTN_TRAFO:LOAD-IMAGE-DOWN ("bilder\flik3.gif") IN FRAME {&FRAME-NAME}.
   BTN_LINA:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
   BTN_LINA:LOAD-IMAGE-DOWN ("bilder\flik3.gif") IN FRAME {&FRAME-NAME}.
   BTN_BER:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
   BTN_BER:LOAD-IMAGE-DOWN ("bilder\flik3.gif") IN FRAME {&FRAME-NAME}.
   BTN_UPP:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
   BTN_UPP:LOAD-IMAGE-DOWN ("bilder\flik3.gif") IN FRAME {&FRAME-NAME}.
...
------------------------------------------------------------------------------*/
  ENABLE BTN_BER RECT-10 BTN_KOPP BTN_LINA BTN_TRAFO BTN_UPP 
...
/*   BUTTON-6:LOAD-MOUSE-POINTER("GLOVE":U). */ 
   ...
   IF val = 1 THEN DO:
      ...
      FRAME FRAME-F:HIDDEN = TRUE.
      FRAME FRAME-G:HIDDEN = TRUE.
      BTN_TRAFO:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
      BTN_LINA:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
      BTN_BER:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
      BTN_UPP:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
   ...
   ELSE IF val = 2 THEN DO:
      ...
      FRAME FRAME-F:HIDDEN = TRUE.
      FRAME FRAME-G:HIDDEN = TRUE.
      BTN_KOPP:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME} NO-ERROR.
      BTN_LINA:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
      BTN_BER:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
      BTN_UPP:LOAD-IMAGE ("bilder\flik4.gif") IN FRAME {&FRAME-NAME}.
