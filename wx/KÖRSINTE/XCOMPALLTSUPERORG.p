...
KOMPILERA ALLA W mappar = serverprog
\\pc122\delad\pro9\guru\WAONR\ till \\pc122\WebGuru\Komp11\

KOMPILERA ALLA c mappar
curdir = cAONR
\\pc122\delad\pro9\guru\cAONR\ till \\pc122\WebGuru\Komp11\ detta för att servers ska ha c programmen ev onödig 
 OS-COPY VALUE(savedir + filnamnR) VALUE(webbdir + curdir + "\" + filnamnR).
detta för att webcliente ska ha alla c programmen 

KOMPILERA ALLA cls mappar
dirlist = \\pc122\delad\pro9\guru\2GURU\guru 
\\pc122\delad\pro9\guru\2GURU\ till \\pc122\WebGuru\GuruOnWeb\" detta för att webclienten ska ha cls programmen 
  
 COMPILE VALUE(dirlist) SAVE INTO VALUE(webbdir + "2Guru\"). de hamnar automatiskt i rätt under mapp

server får alla cls programmen via webclient uppdate 

TOSHIBAN kompilerar över alla  \\pc122\WebGuru\GuruOnWeb\2Guru\Controls program för rätt excel version


XCOMPALLTSUPER.p GÖR SEDAN "robocopy "\\pc122\WebGuru\Komp11" "\\pc122\WebGuru\GuruOnWeb\wtid" *.* /mir"
så att all filer i \\pc122\WebGuru\Komp11 läggs rätt för server
