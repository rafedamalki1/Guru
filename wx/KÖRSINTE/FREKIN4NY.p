...
PROCEDURE skapasats_UI:   
   FOR EACH tidin NO-LOCK:                                
      DO TRANSACTION:
         ...
         FREKVENS.LOPNR = INTEGER(SUBSTRING(tidin.P2,3,2))
         ...
         FIND FIRST LOP3 WHERE LOP3.KATAR = arvar AND LOP3.ARBKOD = "R" + SUBSTRING(tidin.P3,1,3) AND LOP3.LOPNR = INTEGER(SUBSTRING(tidin.P3,4,2)) NO-LOCK NO-ERROR.
         ...
         END.
         ELSE DO:
            FIND FIRST LOP3 WHERE LOP3.KATAR = arvar AND LOP3.ARBKOD = SUBSTRING(tidin.P3,1,3) AND LOP3.LOPNR = INTEGER(SUBSTRING(tidin.P3,4,2)) NO-LOCK NO-ERROR.
            IF AVAILABLE LOP3 THEN DO:
               ASSIGN
               FREKVENS.BENAMNING = LOP3.BENAMNING
               FREKVENS.ENHET = LOP3.ENHET.
