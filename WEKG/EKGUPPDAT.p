...
PROCEDURE uppdat_UI :
   ...
   IF tempniva = "5" THEN DO:
      ...
      OPEN QUERY p5q FOR EACH EKGP5 WHERE EKGP5.EKGSUBID = tempsubid AND EKGP5.EBRKAT = tempebr NO-LOCK. 
      GET FIRST p5q NO-LOCK.
      DO WHILE AVAILABLE(EKGP5):
         DO TRANSACTION:         
            FIND CURRENT EKGP5 EXCLUSIVE-LOCK.
            ASSIGN
            EKGP5.MONTTIM = 0 EKGP5.BERTIM = 0 EKGP5.MASKTIM = 0 EKGP5.EAMASK = 0 EKGP5.EAOVRIGT = 0 EKGP5.EAUTRUST = 0 EKGP5.ARBETEKOST = 0 EKGP5.MATERIELKOST = 0 EKGP5.MASKINKOST = 0 EKGP5.OVRIGT = 0 EKGP5.UTRUSTKOST = 0  EKGP5.EA = 0 EKGP5.SUMMA = 0.
   ...
   IF tempniva = "4" THEN DO:
      ...
      DO WHILE AVAILABLE(EKGP4):
         DO TRANSACTION:         
            ...
            ASSIGN
            EKGP4.MONTTIM = 0 EKGP4.BERTIM = 0 EKGP4.MASKTIM = 0 EKGP4.EAMASK = 0 EKGP4.EAOVRIGT = 0 EKGP4.EAUTRUST = 0 EKGP4.ARBETEKOST = 0 EKGP4.MATERIELKOST = 0 EKGP4.MASKINKOST = 0 EKGP4.OVRIGT = 0 EKGP4.UTRUSTKOST = 0  EKGP4.EA = 0 EKGP4.SUMMA = 0.
            frekuppdat = FALSE.
   ...
   IF tempniva = "3" THEN DO:
      ...
      DO WHILE AVAILABLE(EKGP3):
         DO TRANSACTION:         
            ...
            ASSIGN
            EKGP3.MONTTIM = 0 EKGP3.BERTIM = 0 EKGP3.MASKTIM = 0 EKGP3.UTRUSTTIM = 0 EKGP3.EAMASK = 0 EKGP3.EAOVRIGT = 0 EKGP3.EAUTRUST = 0 EKGP3.ARBETEKOST = 0 EKGP3.MATERIELKOST = 0 EKGP3.MASKINKOST = 0 EKGP3.OVRIGT = 0 EKGP3.UTRUSTKOST = 0 EKGP3.EA = 0 EKGP3.SUMMA = 0.
            frekuppdat = FALSE.
                  ...
                  IF AVAILABLE EKGRESURSPRIS THEN DO:
                     ...
                     IF EKGRESURSPRIS.REGELID = 4 THEN DO:
                        ...
                        IF tempebr = "KLG2" THEN DO:      
                           EKGP3.UTRUSTTIM = EKGP3.UTRUSTTIM + EKGP3RESURS.ANTAL.                                 
                           EKGP3.EAUTRUST = EKGP3.EAUTRUST + (EKGP3RESURS.ANTAL * EKGRESURSPRIS.EA).                           
                           EKGP3.UTRUSTKOST = EKGP3.UTRUSTKOST + (EKGP3RESURS.ANTAL * EKGRESURSPRIS.PRIS).
                        END.
   ...
   IF tempniva = "2" THEN DO:
      ...
      DO WHILE AVAILABLE(EKGP2):
         DO TRANSACTION:         
            ...
            ASSIGN
            EKGP2.MONTTIM = 0 EKGP2.BERTIM = 0 EKGP2.MASKTIM = 0 EKGP2.UTRUSTTIM = 0 EKGP2.EAMASK = 0 EKGP2.EAOVRIGT = 0 EKGP2.EAUTRUST = 0 EKGP2.ARBETEKOST = 0 EKGP2.MATERIELKOST = 0 EKGP2.MASKINKOST = 0 EKGP2.OVRIGT = 0 EKGP2.UTRUSTKOST = 0 EKGP2.EA = 0 EKGP2.SUMMA = 0.
            frekuppdat = FALSE.
            ...
            IF EKGP2.FREKVENS = TRUE AND frekuppdat = TRUE THEN DO:              
               FOR EACH EKGP2FREKVENS WHERE EKGP2FREKVENS.EKGSUBID = tempsubid AND EKGP2FREKVENS.EBRKAT = tempebr AND EKGP2FREKVENS.P2ARBKOD = EKGP2.P2ARBKOD AND EKGP2FREKVENS.P2LOPNR = EKGP2.P2LOPNR NO-LOCK:
                  ...
                  IF AVAILABLE EKGP3  THEN DO:
                     ...
                     EKGP2.UTRUSTTIM = EKGP2.UTRUSTTIM + (EKGP2FREKVENS.ANTAL * EKGP3.UTRUSTTIM).
                     ...
                     EKGP2.UTRUSTKOST = EKGP2.UTRUSTKOST + (EKGP2FREKVENS.ANTAL * EKGP3.UTRUSTKOST).
               ...
               EKGP2RESURS.P2ARBKOD = EKGP2.P2ARBKOD AND  EKGP2RESURS.P2LOPNR = EKGP2.P2LOPNR NO-LOCK:                  
                  ...
                  IF AVAILABLE EKGRESURSPRIS THEN DO:
                     ...
                     IF EKGRESURSPRIS.REGELID = 4 THEN DO:
                        ...
                        END.
                        IF tempebr = "KLG2" THEN DO:                                               
                           EKGP2.UTRUSTTIM = EKGP2.UTRUSTTIM + EKGP2RESURS.ANTAL.                                 
                           EKGP2.EAUTRUST = EKGP2.EAUTRUST + (EKGP2RESURS.ANTAL * EKGRESURSPRIS.EA).                           
                           EKGP2.UTRUSTKOST = EKGP2.UTRUSTKOST + (EKGP2RESURS.ANTAL * EKGRESURSPRIS.PRIS).                           
                        END.                                                          
                     END.
                     IF EKGRESURSPRIS.REGELID = 4 THEN DO:
                        /*EAFAKTOR*/
   ...
   IF tempniva = "1" THEN DO:
      ...
      DO WHILE AVAILABLE(EKGP1):
         DO TRANSACTION:         
            ...
            ASSIGN
            EKGP1.MONTTIM = 0 EKGP1.BERTIM = 0 EKGP1.MASKTIM = 0 EKGP1.UTRUSTTIM = 0 EKGP1.EAMASK = 0 EKGP1.EAOVRIGT = 0 EKGP1.EAUTRUST = 0 EKGP1.ARBETEKOST = 0 EKGP1.MATERIELKOST = 0 EKGP1.MASKINKOST = 0 EKGP1.OVRIGT = 0 EKGP1.UTRUSTKOST = 0 EKGP1.EA = 0 EKGP1.SUMMA = 0.
            IF EKGP1.FREKVENS = TRUE THEN DO:                
               FOR EACH EKGP1FREKVENS WHERE EKGP1FREKVENS.EKGSUBID = tempsubid AND EKGP1FREKVENS.EBRKAT = tempebr AND EKGP1FREKVENS.P1ARBKOD = EKGP1.P1ARBKOD AND EKGP1FREKVENS.P1LOPNR = EKGP1.P1LOPNR NO-LOCK:
                  ...
                  IF AVAILABLE EKGP2  THEN DO:
                     ...
                     EKGP1.UTRUSTTIM = EKGP1.UTRUSTTIM + (EKGP1FREKVENS.ANTAL * EKGP2.UTRUSTTIM). 
                     ...
                     EKGP1.UTRUSTKOST = EKGP1.UTRUSTKOST + (EKGP1FREKVENS.ANTAL * EKGP2.UTRUSTKOST).
