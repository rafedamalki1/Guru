...
RESTIDTAB.KOD = ANSTFORMTAB.KOD AND RESTIDTAB.ENFL = "enbil" AND 
...
ELSE DO:
   IF rslutsek > stop1 AND rslutsek le stop2 THEN DO:
      ...
      SUBSTRING(tidbuff.PROGRAM,1,158) = "RESTID1" + STRING(TODAY) + STRING(TIME,"HH:MM") + Guru.Konstanter:globanv
