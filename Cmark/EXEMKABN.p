...
PROCEDURE skapamua_UI :
   ...
   ELSE IF vdok = "KABLUFT" OR vdok = "KABLUFTUE" THEN DO:
      IF gforetag = "UMEA" THEN DO:
         fnamn = "MUAKabelLuft.XLS".
          fnamnA = "MUAKabelLuft".
          fnamnB = ".XLS".
      END.    
      IF gforetag = "UMBR" THEN DO:
         fnamn = "MUAKabelLuftB.XLS".
          fnamnA = "MUAKabelLuftB".
          fnamnB = ".XLS".
      END.       
   END.
   ELSE IF vdok = "KABLSP"  THEN DO:
      fnamn = "KABELMVSUTlsp.XLS".
      fnamnA = "KABELMVSUTlsp".
      fnamnB = ".XLS".   
   END.
   ASSIGN    
   kabelmsvut1 = 137
...
PROCEDURE skapdok_UI.
  DEF VAR hjfastnamn AS CHARACTER.
   ...
   FIND FIRST emarkval USE-INDEX MARKNR NO-LOCK NO-ERROR.  
   ...
   FIND FIRST marag WHERE marag2.PERSONNUMMER =  emarkval.PERSONNUMMER NO-LOCK NO-ERROR.
   ...
   IF markag > 1  THEN DO:
      FIND FIRST emarkvalbuff USE-INDEX MARKNR NO-LOCK.
      FIND NEXT emarkvalbuff USE-INDEX MARKNR NO-LOCK NO-ERROR.
      IF extram = 0 THEN DO:
         iColumn = 13.
         cColumn = STRING(iColumn).
         cRange = bytacol + cColumn.
   ...
   ELSE DO:
      ...
      IF INTEGER(SUBSTRING(marag2.PERSONNUMMER,3,2)) GE 20 THEN DO:
         ...
         DEBUGGER:SET-BREAK().   
         IF extram = 0 THEN DO:   
            /*måste sättas tillbaka efteråt Lena 20190701*/   
