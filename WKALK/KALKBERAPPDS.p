...
/*------------------------------------------------------------------------
    ...
    Description : SKICKA TEMP TABEL HANDLES ÖVER APPSERVER 
                   OUTPUT TTH
...
PROCEDURE KalkStopp_UI :
   ...
   IF vadgora = 2 THEN DO:
      /*GÅR UR KALKYL MODULEN TAR BORT LÅSNING*/
...
PROCEDURE RefUE_UI :   
   ...
   IF uekal = TRUE THEN DO:
      ...
      END.
      FIND FIRST KALKFAKTORER WHERE KALKFAKTORER.KALKNR = uenr AND  KALKFAKTORER.BENAMNING = "Montör" NO-LOCK NO-ERROR.
      FOR EACH KALKNUMSUB WHERE KALKNUMSUB.KALKNR = uenr AND  KALKNUMSUB.BENAMNING = "Montör"  NO-LOCK:
      ...
      END.
      FIND FIRST KALKFAKTORER WHERE KALKFAKTORER.KALKNR = uenr AND  KALKFAKTORER.BENAMNING = "ÖVRIGKOSTNAD" NO-LOCK NO-ERROR.
      FOR EACH KALKNUMSUB WHERE KALKNUMSUB.KALKNR = uenr AND  KALKNUMSUB.BENAMNING = "ÖVRIGKOSTNAD"  NO-LOCK:
...
PROCEDURE esmallhmt_UI:
   ...
   ELSE IF  avtalvar BEGINS "2016" OR avtalvar BEGINS "20172017" THEN DO:
      ...
      sterad = 20  
      slerad = 1055      
      /*FROM 20161018 bytt från flik 13 till flik 1*/
      flik1 = 1
      flik2 = 1      
      frist = 1127
      frisl = 1161.      
   ...
   ELSE IF  avtalvar BEGINS "2018" OR avtalvar BEGINS "20192019" THEN DO:  /*20182018*/
     /* oversatt137 = TRUE för att eonmallen 20182018 styr mot KLG2017 för 137 koder*/
      /*oversatt137 = TRUE .*/
      ASSIGN
      sterad = 18  
      slerad = 1152
...
PROCEDURE inframallhmt_UI:   
   ...
   IF kalkstber = TRUE THEN DO:
      ...
      ELSE DO:   
         IF avtalvar BEGINS  "2019"  THEN DO:
            ...
            sterad2 = 18   /*20*/  
            slerad2 = 52   /*44*/
            sterad3 = 10    /*kraftringens mall för egna koder  istället för sterad2*/
            slerad3 = 59
   ...
   ELSE DO:     
      IF avtalvar BEGINS  "2017" OR avtalvar BEGINS  "2018" THEN DO:
         ...
         sterad3 = 6  
         slerad3 = 15
         frist = 1100   /* 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
         flik1 = 4
         flik2 = 5.
      END.
      ELSE IF ExelKommando MATCHES "*Kraftringen EBR kostnadskalkyl KLG*" THEN DO:
         IF avtalvar BEGINS  "2019"  THEN DO:
            ...
            sterad3 = 6  
            slerad3 = 15
            frist = 1040   /* 1040 + 10 = 1050   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
            flik1 = 4
            flik2 = 5.
         END.
         ELSE IF avtalvar BEGINS  "2020"  THEN DO:
            ...
            sterad3 = 6  
            slerad3 = 15
            frist = 1051   /* 1051 + 10 = 1061   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
            flik1 = 4
            flik2 = 5.
         END.
         ELSE DO:
      ...
      ELSE IF avtalvar BEGINS  "2019" THEN DO:
         ...
         sterad3 = 6  
         slerad3 = 15
         frist = 1035   /* 1035 + 21 = 1056   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
         flik1 = 4
         flik2 = 6.
      END.
      ELSE IF avtalvar BEGINS "20202020" THEN DO:
         ...
         sterad3 = 6  
         slerad3 = 15
         frist = 1043   /* 1043 + 21 = 1064   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
         flik1 = 4
         flik2 = 6.
      END. 
      ELSE IF  avtalvar BEGINS "20202021" THEN DO:
         ...
         sterad3 = 6  
         slerad3 = 15
         frist = 1042   /* 1042 + 21 = 1063   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
         flik1 = 4
         flik2 = 6.
      END.
      ELSE IF  avtalvar BEGINS "2021" THEN DO:
         ...
         sterad3 = 6  
         slerad3 = 15
         frist = 1001  /* 1001 + 21 = 1022   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
         flik1 = 5
         flik2 = 7.
      END.
      ELSE DO:
         ...
         sterad3 = 6  
         slerad3 = 15
         frist = 1011  /* 1011 + 21 = 1032   1037 + 18 = 1055 1100 + 18 = 1118  1060 + 18 = 1078 för  2015   1023 + 20 = 1043   1017 + 20 =1037*/
         flik1 = 5
         flik2 = 7.
      END.   
   END.      
...
PROCEDURE FlyttaKalkylNykat_UI :
   ...
   DO TRANSACTION:
      ...
      ELSE DO:
         ...
         IF KALKYLKATALOG.VISARTAL = 1999 THEN DO:
            CREATE tidut.
            tidut.UT = "Kalkylen går ej att flytta då den är gjord enligt " + STRING(KALKYLKATALOG.VISARTAL)  + " års kostnadskatalog. Formatet har ändrats.".
            tidut.TTRECID = RECID(tidut).
            RETURN.   
         END.
         IF ABSOLUTE(KALKYLKATALOGBUF.VISARTAL - KALKYLKATALOG.VISARTAL) > 3 THEN DO:
            CREATE tidut.
            tidut.UT = "Kalkylen går ej att flytta då den är bygger på en för gammal kostnadskatalog.".
            tidut.TTRECID = RECID(tidut).
            RETURN.      
         END.
      END.
...
PROCEDURE copycatFRI_UI :
   ...
   DO TRANSACTION:
      ...
      ELSE DO:
         ...
         END.   
         ELSE DO:
            /*FRÅN PLAN TILL AONRKALK ENDAST AKTIVA AONR*/
            ASSIGN    
            KALKAONR.AONR = nyaonr
            KALKAONR.DELNR = nyadelnr
            KALKAONR.PLANNR = ?
   ...
   END.
   /*Anders Olsson Elpool i Umeå AB  15 maj 2017 14:58:47 
   det blir fel priser om man byter katår 
   */
...
PROCEDURE oversatt_UI:
   ...
   ELSE DO:      
      ...
      FIND FIRST KALKYLKATALOG WHERE KALKYLKATALOG.KLOGID = NyKatIdvar NO-LOCK NO-ERROR.
      IF KALKYLKATALOG.BENAMNING = "EBR 2018" OR KALKYLKATALOG.BENAMNING = "ANVÄND EJ EBR 2018" THEN DO:
      ...
      IF KALKYLKATALOG.BENAMNING = "EBR 2017" OR KALKYLKATALOG.BENAMNING = "EBR 2017/2018" THEN DO:
         IF KALKYLKATALOGBUF.BENAMNING = "EBR 2018" OR KALKYLKATALOGBUF.BENAMNING = "ANVÄND EJ EBR 2018"   THEN DO:
            FOR EACH KalkylimportTT WHERE KalkylimportTT.HJUPPDAT = 0 AND KalkylimportTT.ARBKOD = "137" NO-LOCK:
...
PROCEDURE schaktberidlhmt_UI :
   ...
   /*hitta schaktet som beredningskonstruktionerna är importerade till Lena 20200225*/
