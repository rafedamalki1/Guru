...
Define {1} workfile w_Field NO-UNDO like _Field.
Define {1} workfile w_FTrig NO-UNDO like _Field-trig.
------------------------------------------------------------------*/
...
/*------------
{as4dict/FLD/fldprop.f  &frame_phrase = "frame domprops CENTERED NO-BOX"}
-------------*/
