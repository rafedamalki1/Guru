...
DEFINE FRAME DEFAULT-FRAME
     ...
     "Annat, tex administratör av Guru" VIEW-AS TEXT
     ...
     "Beredare" VIEW-AS TEXT
          ...
          FONT 8
     "Min användarroll i Guru är:" VIEW-AS TEXT
...
DEFINE FRAME DEFAULT-FRAME
     "Guru och karta, markvärdering, mobil mm?" VIEW-AS TEXT
