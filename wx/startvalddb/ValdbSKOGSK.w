...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW_VDB C-Win _STRUCTURED
  QUERY BRW_VDB DISPLAY
      valdbtemp.VALDB FORMAT "X(250)":U WIDTH 31
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
...
"VALDB" ? "X(250)" "character" ? ? ? ? ? ? no ? no no "31" yes no no "U" "" "" "" "" "" "" 0 no 0 no no
     _Query            is OPENED
*/  /* BROWSE BRW_VDB */
&ANALYZE-RESUME
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   {VALDBPICA.I}
   {VALDBJSBF.I}
   OPEN QUERY {&BROWSE-NAME}  FOR EACH valdbtemp USE-INDEX ORDNING2.   
   {VALDBMAIN.I}
