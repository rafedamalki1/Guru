...
IF globforetag = "VATT" THEN DO:                        
   prognamndat = "/guru/export/lon/stanstid.d".
   prognamnque = "/guru/export/lon/stanstid" + ".q".
END. 
ELSE DO:  
   prognamndat = "D:\delad\pro8\GURU\apptemp\stanstid.d".
   prognamnque = "D:\delad\pro8\GURU\apptemp\stanstid" + ".q".
END.   
...
IF globforetag = "VATT" THEN DO: 
   INPUT FROM /guru/export/lon/stanstid.q NO-ECHO.
END. 
ELSE IF globforetag = "ELPA" THEN DO: 
   INPUT FROM D:\delad\pro8\GURU\apptemp\stanstid.q NO-ECHO.
END.  
REPEAT TRANSACTION:
  CREATE lonut.
  ASSIGN.
...
IF globforetag = "ELPA" THEN DO: 
   ...
   OUTPUT TO D:\delad\pro8\GURU\apptemp\stanstid.d NO-ECHO.
   FOR EACH lonut BY lonut.strang:     
      PUT lonut.strang SKIP.       
   END.   
   OUTPUT CLOSE.  
