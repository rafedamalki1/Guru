...
DEFINE INPUT PARAMETER TABLE FOR eperstemp.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  {FRMSIZEDF.I}
  RUN PERSVISDYN.P PERSISTENT SET bestdynh (INPUT THIS-PROCEDURE, INPUT framesizeh,INPUT TABLE whandltemp).
  IF mdep = 1 THEN RUN skapabrw_UI IN bestdynh (INPUT 1,INPUT 1, TEMP-TABLE eperstemp:DEFAULT-BUFFER-HANDLE).
  IF mdep = 2 THEN RUN skapabrw_UI IN bestdynh (INPUT 2,INPUT 1, TEMP-TABLE eperstemp:DEFAULT-BUFFER-HANDLE).
