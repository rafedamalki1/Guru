...
/* DEFINE INPUT PARAMETER valgrupp LIKE KONSTGRUPP.KONSKOD NO-UNDO.  */
   ...
   ELSE IF globforetag = "SUND" THEN DO:
      ...
      /*OUTPUT TO D:\DELAD\KLIENT\PRO9\konstgr.d convert target "iso8859-1" source "iso8859-1".*/
   END.
   ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\konstgr.d  convert target "iso8859-1" source "iso8859-1".    
   END.   
   ...
   END.
   ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\bbenamn.d  convert target "iso8859-1" source "iso8859-1".   
   END.         
   ELSE IF globforetag = "elpa" OR globforetag = "NYLB" THEN DO:
   ...
   END.
      ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\edigrupp.d  convert target "iso8859-1" source "iso8859-1".    
   END.   
   ...
   END.
   ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\konstru.d  convert target "iso8859-1" source "iso8859-1".    
   END.   
   ELSE IF globforetag = "elpa" OR globforetag = "NYLB" THEN DO:
   ...
   END.
   ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\konstval.d  convert target "iso8859-1" source "iso8859-1".    
   END.   
   ...
   END.
   ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\mtrlber.d  convert target "iso8859-1" source "iso8859-1".    
   END.   
   ELSE IF globforetag = "elpa" OR globforetag = "NYLB" THEN DO:
   ...
   END.
   ELSE IF globforetag = "PPKO"  THEN DO:
      OUTPUT TO C:\PRO10\GURU\WTID\kalkber.d  convert target "iso8859-1" source "iso8859-1".    
   END.
   ELSE IF globforetag = "elpa" OR globforetag = "NYLB" THEN DO:
