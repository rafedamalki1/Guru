...
CREATE WIDGET-POOL.
&global-define TableName      employee
...
&Scoped-Define ENABLED-OBJECTS fLastName fFirstName fAddress fCity fState ~
BtnOK BtnGet BtnDone RECT-1 
&Scoped-Define DISPLAYED-OBJECTS fLastName fFirstName fAddress fCity fState 
...
DEFINE FRAME CustFrame
     fLastName AT ROW 9.33 COL 20 COLON-ALIGNED
     fFirstName AT ROW 10.52 COL 20 COLON-ALIGNED
     fAddress AT ROW 11.71 COL 20 COLON-ALIGNED
     fCity AT ROW 12.91 COL 20 COLON-ALIGNED
     fState AT ROW 14.1 COL 19 COLON-ALIGNED
...
------------------------------------------------------------------------------*/
  DISPLAY fLastName fFirstName fAddress fCity fState 
      WITH FRAME CustFrame IN WINDOW C-Win.
  ENABLE fLastName fFirstName fAddress fCity fState BtnOK BtnGet BtnDone RECT-1 
      WITH FRAME CustFrame IN WINDOW C-Win.
