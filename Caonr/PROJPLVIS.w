...
{VISUTSOKAONR.I} 
{WHANDLTEMP.I}
DEFINE INPUT PARAMETER TABLE FOR eplutsokaonr.
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Lönearter kopplat till avtal */
DO:   
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   RUN enable_UI.
  {FRMSIZEDF.I}  
  RUN PROJPLVISDYN.P PERSISTENT SET bestdynh (INPUT THIS-PROCEDURE, INPUT framesizeh,INPUT TABLE whandltemp).
  RUN skapabrw_UI IN bestdynh (INPUT 1,INPUT 1, TEMP-TABLE eplutsokaonr:DEFAULT-BUFFER-HANDLE).  
  {DIA_M_SLUT.I}  
