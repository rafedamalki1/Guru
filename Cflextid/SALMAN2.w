...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 106.5 BY 19.75.
...
DEFINE FRAME FRAME-TIDS
     ...
     BTN_SKRIV AT ROW 21.58 COL 77.38
     BTN_AVS AT ROW 21.58 COL 94
...
-------------------------------------------------------------*/
   IF Guru.Konstanter:appcon THEN DO:
      RUN SALMANAP2.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT
      (INPUT arnr,INPUT manadnamn,INPUT manadnr,INPUT pkod,
       OUTPUT TABLE tidut).
   END.
   ELSE DO:
      RUN SALMANAP2.P 
