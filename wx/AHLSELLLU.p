/*AHLSELLLU.P INLÄSNING AV PRISFIL AHLSELL*/       
...
{muswait.i} 
ASSIGN
/*   filnamn = "\\server04\d\elpool\elpnj\tectel\materiel\TectelELtot.skv" */
filnamn = "F:\elpool\elpnj\Luleå\Priser20091117\AH.skv"
...
/*             EXPORT tidinah. */
            ...
            IF FORETAG.FORETAG = "LULE" OR FORETAG.FORETAG = "ELPA" THEN DO:
               mtrlbuff.BPRIS = mtrlbuff.NPRIS.
            END.
            IF FORETAG.FORETAG = "TECT" OR FORETAG.FORETAG = "CELPA" THEN DO:
               mtrlbuff.BPRIS = tidinah.BPRIS / 100.
            END.
/*             mtrlbuff.BPRIS = tidinah.BPRIS / 100. */
/*             mtrlbuff.NPRIS = tidinah.NPRIS / 100. */
