...
run adedict/FLD/fldworkf.p (INPUT {&MAIN_TO_WORK}, OUTPUT junk).
------------------------------------------------------------------*/
...
do:
   /* I am cheating here in that type_ix is based on For-Type and I
      am counting on the fact that Progress doesn't allow changing of 
