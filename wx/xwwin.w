  ...
  CASE currentPage: 
    ...
    WHEN 0 THEN DO:
       RUN constructObject (
             ...
             INPUT  'FolderLabels':U + 'Mikael|Germund|Anders' + 'FolderTabWidth15FolderFont-1HideOnInitnoDisableOnInitnoObjectLayout':U ,
             OUTPUT h_folder ).
       RUN repositionObject IN h_folder ( 1.00 , 1.50 ) NO-ERROR.
       RUN resizeObject IN h_folder ( 15.50 , 75.00 ) NO-ERROR.
