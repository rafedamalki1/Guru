...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS MULTIPLE SIZE 75.25 BY 19.25.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     FILL-IN-REGIS AT ROW 3.42 COL 4.5 COLON-ALIGNED NO-LABEL
     FILL-IN_NAMN AT ROW 3.42 COL 24 COLON-ALIGNED HELP
          "ANGE ORAGNISTIONENSBENÄMNING" NO-LABEL
     FILL-IN_FORNAMN AT ROW 3.42 COL 24 COLON-ALIGNED NO-LABEL
     FILL-IN_EFTERNAMN AT ROW 3.42 COL 45.5 COLON-ALIGNED NO-LABEL
     FILL-IN-AR AT ROW 5.04 COL 33.25 COLON-ALIGNED NO-LABEL
     FILL-IN-MANAD AT ROW 5.04 COL 42.5 COLON-ALIGNED NO-LABEL
     BRW_TID-2 AT ROW 6.29 COL 1.5
     FBTN_VISA AT ROW 8 COL 78.25
     RAD_ALLVAL AT ROW 13.79 COL 13 NO-LABEL
     BTN_GODM AT ROW 26.13 COL 30.25
     BTN_AVB AT ROW 26.13 COL 78.25
     "Det finns inga tidsedlar att godkänna" VIEW-AS TEXT
          SIZE 57 BY 3.5 AT ROW 9.54 COL 10.5
          FONT 17
     "Godkänna tidsedlar för:" VIEW-AS TEXT
          SIZE 43.88 BY 1.33 AT ROW 1.29 COL 1.5
          FONT 17
...
"godmarkpers.DATUM" "Färdig till" ? "date" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[5]   > Temp-Tables.godmarkpers.GODKAND
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   IF NOT AVAILABLE godmarkpers THEN DO:
      ...
      DISABLE BTN_GODM WITH FRAME {&FRAME-NAME}.
   END.
   ELSE DO:    
