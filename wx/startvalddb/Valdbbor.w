...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW_VDB C-Win _STRUCTURED
  QUERY BRW_VDB DISPLAY
      valdbtemp.VALDB FORMAT "X(45)":U WIDTH 36.5
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-ROW-MARKERS NO-COLUMN-SCROLLING SIZE 39 BY 6.83
         FONT 4
...
DEFINE FRAME DEFAULT-FRAME
     BRW_VDB AT ROW 3.25 COL 1.5
     BTN_START AT ROW 5.5 COL 41.63
     BTN_AVB AT ROW 9.08 COL 41.63
...
"valdbtemp.VALDB" ? "X(45)" "character" ? ? ? ? ? ? no ? no no "36.5" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BRW_VDB */
&ANALYZE-RESUME
