...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 80.5 BY 26.25.
...
DEFINE FRAME FRAME-TIDS
     ...
     BTN_SKRIV AT ROW 28.17 COL 52.5
     BTN_AVB AT ROW 28.17 COL 68
...
"===========================================================================================================".   
   ...
   IF Guru.Konstanter:appcon THEN DO:                                 
      RUN APKTARB.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT 
   ...
   END.
   ELSE DO:
      MESSAGE "Alla sökta personers tider under månad " MONTH(avdatum) "-" YEAR(avdatum) " stämmer med deras arbetstider."
      VIEW-AS ALERT-BOX.      
