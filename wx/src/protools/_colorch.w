...
&Scoped-Define ENABLED-OBJECTS b_Help Cancel-But Color-0 Color-1 Color-10 ~
Color-11 Color-12 Color-13 Color-14 Color-15 Color-2 Color-3 Color-4 ~
Color-5 Color-6 Color-7 Color-8 Color-9 OK-But RECT-4 Revert-But 
...
DEFINE FRAME FRAME-A
     Cancel-But AT ROW 1.28 COL 79
     OK-But AT ROW 2.78 COL 79
     Revert-But AT ROW 4.28 COL 79
     b_Help AT ROW 5.78 COL 79
     " Colors" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1 COL 4
     RECT-4 AT ROW 1.28 COL 3
     "Color 0" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1.8 COL 5
     "Color 1" VIEW-AS TEXT
          SIZE 6.5 BY .64 AT ROW 1.8 COL 14
     "Color 2" VIEW-AS TEXT
          SIZE 7 BY .64 AT ROW 1.8 COL 23
     "Color 3" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1.8 COL 32
     "Color 4" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1.8 COL 41
     "Color 5" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1.8 COL 50
     "Color 6" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1.8 COL 59
     "Color 7" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 1.8 COL 68
     Color-0 AT ROW 2.8 COL 5
     Color-1 AT ROW 2.8 COL 14
     Color-2 AT ROW 2.8 COL 23
     Color-3 AT ROW 2.8 COL 32
     Color-4 AT ROW 2.8 COL 41
     Color-5 AT ROW 2.8 COL 50
     Color-6 AT ROW 2.8 COL 59
     Color-7 AT ROW 2.8 COL 68
     "Color 8" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 4.24 COL 5
     "Color 9" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 4.24 COL 14
     "Color 10" VIEW-AS TEXT
          SIZE 9 BY .64 AT ROW 4.24 COL 23
     "Color 11" VIEW-AS TEXT
          SIZE 7.67 BY .64 AT ROW 4.24 COL 32
     "Color 12" VIEW-AS TEXT
          SIZE 9 BY .64 AT ROW 4.24 COL 41
     "Color 13" VIEW-AS TEXT
          SIZE 9 BY .64 AT ROW 4.24 COL 50
     "Color 14" VIEW-AS TEXT
          SIZE 8 BY .64 AT ROW 4.24 COL 59
     "Color 15" VIEW-AS TEXT
          SIZE 9 BY .64 AT ROW 4.24 COL 68
...
IF NOT w_Color:LOAD-ICON("adeicon/clrchnge") THEN
...
------------------------------------------------------------------------------*/
  ...
  IF SESSION:DISPLAY-TYPE eq "GUI":U THEN DELETE WIDGET w_Color.
...
------------------------------------------------------------------------------*/
  ENABLE RECT-4 Cancel-But Color-0 Color-1 Color-2 Color-3 Color-4 Color-5 
         Color-6 Color-7 OK-But Revert-But Color-8 Color-9 Color-10 Color-11 
