...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-ROW-MARKERS NO-COLUMN-SCROLLING SIZE 33.5 BY 6.83
...
DEFINE FRAME DEFAULT-FRAME
     ...
     BTN_START AT ROW 6 COL 36.88
     BTN_AVB AT ROW 9.58 COL 36.88
     "Välj databas för start av Guru !" VIEW-AS TEXT
          SIZE 35.25 BY 1.5 AT ROW 1.5 COL 1.5
          FONT 17
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   REPOSITION {&BROWSE-NAME} TO ROWID ROWID(valdbtemp).
   APPLY "VALUE-CHANGED" TO {&BROWSE-NAME}.
