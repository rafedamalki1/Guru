...
DEFINE INPUT PARAMETER TABLE FOR bertrafftemp.
...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Träff konstruktionsgrupp konstruktion i beredningar"
...
ON WINDOW-CLOSE OF FRAME Dialog-Frame /* Träff konstruktioner i beredningar */
DO:   
...
EMPTY TEMP-TABLE whandltemp NO-ERROR. 
   ...
   RUN BERTRAFFVISDYN.P PERSISTENT SET bestdynh (INPUT THIS-PROCEDURE, INPUT FRAME Dialog-FRAME:HANDLE,INPUT TABLE whandltemp).  
   RUN skapabrw_UI IN bestdynh (INPUT 1,INPUT 1, TEMP-TABLE bertrafftemp:DEFAULT-BUFFER-HANDLE).
