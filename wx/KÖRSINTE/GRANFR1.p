...
END.      
IF Guru.Konstanter:globforetag = "GRAN" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\gran\franfel.d NO-ECHO.
END.  
ELSE IF Guru.Konstanter:globforetag = "GADM" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\gadm\franfel.d NO-ECHO.
END.  
ELSE IF Guru.Konstanter:globforetag = "GRIT" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\grit\franfel.d NO-ECHO.
END. 
ELSE IF Guru.Konstanter:globforetag = "GKAL" THEN DO:
   INPUT FROM d:\DELAD\server\PRO9S\gkal\franfel.d NO-ECHO.
END. 
ELSE IF Guru.Konstanter:globforetag = "GKRVA" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\gkrva\franfel.d NO-ECHO.
END. 
ELSE DO:
   INPUT FROM \\pc112\delad\pro9s\korning\franfel.d NO-ECHO.
END.   
REPEAT TRANSACTION:
  CREATE frfel.
  ASSIGN.
...
END.
IF Guru.Konstanter:globforetag = "GRAN" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\gran\franfor.d NO-ECHO.
END.  
ELSE IF Guru.Konstanter:globforetag = "GADM" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\gadm\franfor.d NO-ECHO.
END.  
ELSE IF Guru.Konstanter:globforetag = "GRIT" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\grit\franfor.d NO-ECHO.
END. 
ELSE IF Guru.Konstanter:globforetag = "GKAL" THEN DO:
   INPUT FROM d:\DELAD\server\PRO9S\gkal\franfor.d NO-ECHO.
END. 
ELSE IF Guru.Konstanter:globforetag = "GKRVA" THEN DO:
   INPUT FROM \\GRANGURU\guru_ser\server\PRO9S\gkrva\franfor.d NO-ECHO.
END. 
ELSE DO:
   INPUT FROM \\pc112\delad\pro9s\korning\franfor.d NO-ECHO.
END.   
REPEAT TRANSACTION:
  CREATE frfor.
  ASSIGN.
...
DO WHILE AVAILABLE(PERSONALTAB):
   ...
   END.
   IF Guru.Konstanter:globforetag = "elpa" OR Guru.Konstanter:globforetag = "CGKAL" THEN DO:
      personal = PERSONALTAB.PERSONNUMMER.
   END.   
      ...
      IF krav = 0 THEN DO:  
         ...
         IF AVAILABLE FVARO THEN DO TRANSACTION:
           ...
           ELSE DO:
            ...
            END.      
            IF PERSONALTAB.OMREGTID = 1 AND franvaro.LART = "511" THEN DO:
               CREATE frfor.
               ASSIGN frfor.PERSONALKOD = franvaro.PERSONALKOD frfor.AONR = franvaro.AONR
               frfor.DELNR = franvaro.DELNR frfor.LART = franvaro.LART 
               frfor.FRAN =   franvaro.FRAN frfor.TILL = franvaro.TILL 
               frfor.PROCENT = franvaro.PROCENT frfor.TIMMAR = franvaro.TIMMAR.
            END.
         END.   	    
      END.
...
END.
IF Guru.Konstanter:globforetag = "GRAN" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\gran\franfel.d NO-ECHO.
END.    
ELSE IF Guru.Konstanter:globforetag = "GADM" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\gadm\franfel.d NO-ECHO.
END.
ELSE IF Guru.Konstanter:globforetag = "GRIT" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\grit\franfel.d NO-ECHO.
END.
ELSE IF Guru.Konstanter:globforetag = "GKAL" THEN DO:
   OUTPUT TO d:\DELAD\server\PRO9S\gkal\franfel.d NO-ECHO.
END.
ELSE IF Guru.Konstanter:globforetag = "GKRVA" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\gkrva\franfel.d NO-ECHO.
END.
ELSE DO:
...
IF Guru.Konstanter:globforetag = "GRAN" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\gran\franfor.d NO-ECHO.
END.    
ELSE IF Guru.Konstanter:globforetag = "GADM" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\gadm\franfor.d NO-ECHO.
END.
ELSE IF Guru.Konstanter:globforetag = "GRIT" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\grit\franfor.d NO-ECHO.
END.
ELSE IF Guru.Konstanter:globforetag = "GKAL" THEN DO:
   OUTPUT TO d:\DELAD\server\PRO9S\gkal\franfor.d NO-ECHO.
END.
ELSE IF Guru.Konstanter:globforetag = "GKRVA" THEN DO:
   OUTPUT TO \\GRANGURU\guru_ser\server\PRO9S\gkrva\franfor.d NO-ECHO.
END.
ELSE DO:
