...
DEFINE VARIABLE p_delid  AS INTEGER   INITIAL 0640 NO-UNDO.
DEFINE VARIABLE p_dir    AS LOGICAL                NO-UNDO.
DEFINE VARIABLE p_flag   AS INTEGER   EXTENT  0640 NO-UNDO.
...
DEFINE VARIABLE p_name   AS CHARACTER EXTENT  0640 NO-UNDO.
