...
/*DEFINE INPUT PARAMETER TABLE FOR sekperstemp.*/


/* Local Variable Definitions ---                                       */
DEFINE VARIABLE sekdynh AS HANDLE NO-UNDO.
...
DO:   
   IF VALID-HANDLE(sekdynh) THEN DO: 
      RUN avs_UI IN sekdynh.
      DELETE PROCEDURE sekdynh NO-ERROR.  
   END.
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN  hamtsek_UI IN anvapph (OUTPUT TABLE sekperstemp). 
  RUN SEKVISDYN.P PERSISTENT SET sekdynh (INPUT THIS-PROCEDURE, INPUT framesizeh,INPUT TABLE whandltemp).
  RUN skapabrw_UI IN sekdynh (INPUT 1,INPUT 1, TEMP-TABLE sekperstemp:DEFAULT-BUFFER-HANDLE).
