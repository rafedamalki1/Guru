...
&Scoped-Define ENABLED-OBJECTS RECT-6 RECT-7 BROWSE-19 BTN_AVSL BTN_NY ~
BTN_AND BTN_BORT 
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BROWSE-19 WINDOW-1 _STRUCTURED
  QUERY BROWSE-19 NO-LOCK DISPLAY
      ...
      KALKKATEGORI.VINAMN
      KALKKATEGORI.PRIS
      KALKKATEGORI.OPRIS COLUMN-LABEL "Ö-PRIS"
      KALKKATEGORI.OMRADE
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-COLUMN-SCROLLING SIZE 66.5 BY 8.5
         BGCOLOR 8 .
...
DEFINE FRAME FRAME-A
     BROWSE-19 AT ROW 2.41 COL 3.5
     BTN_AVSL AT ROW 13.5 COL 57.25
     BTN_NY AT ROW 14 COL 6.5
     BTN_AND AT ROW 14 COL 21.5
     BTN_BORT AT ROW 14 COL 36
     RECT-6 AT ROW 1.5 COL 1.38
...
/* SETTINGS FOR FRAME FRAME-A
                                                                        */
/* BROWSE-TAB BROWSE-19 RECT-7 FRAME-A */
...
/* Query rebuild information for BROWSE BROWSE-19
     ...
     _Options          = "NO-LOCK"
     _FldNameList[1]   = UTBI.KALKKATEGORI.TYP
     _FldNameList[2]   = UTBI.KALKKATEGORI.RADNR
     _FldNameList[3]   = UTBI.KALKKATEGORI.NAMN
     _FldNameList[4]   = UTBI.KALKKATEGORI.VINAMN
     _FldNameList[5]   = UTBI.KALKKATEGORI.PRIS
     _FldNameList[6]   > UTBI.KALKKATEGORI.OPRIS
"OPRIS" "Ö-PRIS" ? "decimal" ? ? ? ? ? ? no ?
     _FldNameList[7]   = UTBI.KALKKATEGORI.OMRADE
     _Query            is OPENED
*/  /* BROWSE BROWSE-19 */
&ANALYZE-RESUME
...
------------------------------------------------------------------------------*/
  ENABLE RECT-6 RECT-7 BROWSE-19 BTN_AVSL BTN_NY BTN_AND BTN_BORT 
