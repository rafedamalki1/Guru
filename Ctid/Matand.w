...
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-MANF FILL-IN-MANL FILL-IN-MANM ~
FILL-IN-TISF FILL-IN-TISL FILL-IN-TISM FILL-IN-ONSF FILL-IN-ONSL ~
FILL-IN-ONSM FILL-IN-TORF FILL-IN-TORL FILL-IN-TORM FILL-IN-FREF ~
FILL-IN-FREL FILL-IN-FREM FILL-IN-LORF FILL-IN-LORL FILL-IN-LORM ~
...
DEFINE FRAME DIALOG-1
     ...
     FILL-IN-MANL AT ROW 4.5 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-MANM AT ROW 4.5 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-TISF AT ROW 5.67 COL 8 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-TISL AT ROW 5.67 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-TISM AT ROW 5.67 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-ONSF AT ROW 6.92 COL 8 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-ONSL AT ROW 6.92 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-ONSM AT ROW 6.92 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-TORF AT ROW 8.08 COL 8 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-TORL AT ROW 8.08 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-TORM AT ROW 8.08 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-FREF AT ROW 9.33 COL 8 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-FREL AT ROW 9.33 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-FREM AT ROW 9.33 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-LORF AT ROW 10.5 COL 8 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-LORL AT ROW 10.5 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-LORM AT ROW 10.5 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-SONF AT ROW 11.67 COL 8 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-SONL AT ROW 11.67 COL 20 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     FILL-IN-SONM AT ROW 11.67 COL 32 COLON-ALIGNED NO-LABEL AUTO-RETURN 
     BTN_REG AT ROW 13.5 COL 13.5
     BTN_AVS AT ROW 13.5 COL 28.5
     "Fri Frukost  Fri Lunch  Fri Middag" VIEW-AS TEXT
          SIZE 36 BY 1 AT ROW 3 COL 6.5
     SPACE(0.62) SKIP(10.66)
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         SIDE-LABELS NO-UNDERLINE THREE-D  SCROLLABLE 
         TITLE "Måltidsavdrag":L.
...
ON END-ERROR OF FRAME DIALOG-1 /* Måltidsavdrag */
DO:
   musz = TRUE.
   RETURN.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL DIALOG-1 DIALOG-1
ON ENDKEY OF FRAME DIALOG-1 /* Måltidsavdrag */
DO:
   musz = TRUE.
   RETURN.
END.
...
DO:                                 
   ...
   REPEAT:
      ...
      IF WEEKDAY(regdatum) = 1 THEN DO:
         ...
         maltidfil.MFRU = FILL-IN-SONF
         maltidfil.MLUN = FILL-IN-SONL
         maltidfil.MMID = FILL-IN-SONM
         maltidfil.MDAG = "sön"
      ...
      IF WEEKDAY(regdatum) = 2 THEN DO:
         ASSIGN maltidfil.MPERSONALKOD = pkod
         maltidfil.MFRU = FILL-IN-MANF
         maltidfil.MLUN = FILL-IN-MANL
         maltidfil.MMID = FILL-IN-MANM
         maltidfil.MDAG = "mån"
         maltidfil.MVECKONUMMER = FILL-IN-VNR
         maltidfil.MDATUM = regdatum.
      END.
      IF WEEKDAY(regdatum) = 3 THEN DO:
         ASSIGN maltidfil.MPERSONALKOD = pkod
         maltidfil.MFRU = FILL-IN-TISF
         maltidfil.MLUN = FILL-IN-TISL
         maltidfil.MMID = FILL-IN-TISM
         maltidfil.MDAG = "tis"
         maltidfil.MVECKONUMMER = FILL-IN-VNR
         maltidfil.MDATUM = regdatum.
      END.
      IF WEEKDAY(regdatum) = 4 THEN DO:
         ASSIGN maltidfil.MPERSONALKOD = pkod
         maltidfil.MFRU = FILL-IN-ONSF
         maltidfil.MLUN = FILL-IN-ONSL
         maltidfil.MMID = FILL-IN-ONSM
         maltidfil.MDAG = "ons"
         maltidfil.MVECKONUMMER = FILL-IN-VNR
         maltidfil.MDATUM = regdatum.
      END.
      IF WEEKDAY(regdatum) = 5 THEN DO:
         ASSIGN maltidfil.MPERSONALKOD = pkod
         maltidfil.MFRU = FILL-IN-TORF
         maltidfil.MLUN = FILL-IN-TORL
         maltidfil.MMID = FILL-IN-TORM
         maltidfil.MDAG = "tor"
         maltidfil.MVECKONUMMER = FILL-IN-VNR
         maltidfil.MDATUM = regdatum.
      END.
      IF WEEKDAY(regdatum) = 6 THEN DO:
         ASSIGN maltidfil.MPERSONALKOD = pkod
         maltidfil.MFRU = FILL-IN-FREF
         maltidfil.MLUN = FILL-IN-FREL
         maltidfil.MMID = FILL-IN-FREM
         maltidfil.MDAG = "fre"
         maltidfil.MVECKONUMMER = FILL-IN-VNR
         maltidfil.MDATUM = regdatum.
      END.
      IF WEEKDAY(regdatum) = 7 THEN DO:
         ASSIGN maltidfil.MPERSONALKOD = pkod
         maltidfil.MFRU = FILL-IN-LORF
         maltidfil.MLUN = FILL-IN-LORL
         maltidfil.MMID = FILL-IN-LORM
         maltidfil.MDAG = "lör"
         maltidfil.MVECKONUMMER = FILL-IN-VNR
         maltidfil.MDATUM = regdatum.
      END.
   ...
   IF musz = FALSE THEN DO:      
      ...
      REPEAT:   
         ...
         IF maltidfil2.MDAG = "mån" THEN DO:
            ASSIGN
            FILL-IN-MANF = maltidfil2.MFRU 
            FILL-IN-MANL = maltidfil2.MLUN
            FILL-IN-MANM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER.           
         END.
         IF maltidfil2.MDAG = "tis" THEN DO:
            ASSIGN
            FILL-IN-TISF = maltidfil2.MFRU 
            FILL-IN-TISL = maltidfil2.MLUN
            FILL-IN-TISM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER.
         END.
         IF maltidfil2.MDAG = "ons" THEN DO:
            ASSIGN
            FILL-IN-ONSF = maltidfil2.MFRU 
            FILL-IN-ONSL = maltidfil2.MLUN
            FILL-IN-ONSM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER.
         END.
         IF maltidfil2.MDAG = "tor" THEN DO:
            ASSIGN
            FILL-IN-TORF = maltidfil2.MFRU 
            FILL-IN-TORL = maltidfil2.MLUN
            FILL-IN-TORM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER.
         END.
         IF maltidfil2.MDAG = "fre" THEN DO:
            ASSIGN
            FILL-IN-FREF = maltidfil2.MFRU 
            FILL-IN-FREL = maltidfil2.MLUN
            FILL-IN-FREM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER.
         END.
         IF maltidfil2.MDAG = "lör" THEN DO:
            ASSIGN
            FILL-IN-LORF = maltidfil2.MFRU 
            FILL-IN-LORL = maltidfil2.MLUN
            FILL-IN-LORM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER.
         END.
         IF maltidfil2.MDAG = "sön" THEN DO:
            ASSIGN
            FILL-IN-SONF = maltidfil2.MFRU 
            FILL-IN-SONL = maltidfil2.MLUN
            FILL-IN-SONM = maltidfil2.MMID
            FILL-IN-VNR = maltidfil2.MVECKONUMMER
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   ASSIGN
   FILL-IN-VNR = regvnr.
   FIND FIRST maltidfil2 NO-LOCK NO-ERROR.
   regdatum = maltidfil2.MDATUM.
   REPEAT:   
