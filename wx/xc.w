...
DEFINE FRAME DEFAULT-FRAME
     "win bg 8 fg 8" VIEW-AS TEXT
          SIZE 31 BY 1.75 AT ROW 14.75 COL 4.5
     "def" VIEW-AS TEXT
          SIZE 8 BY .63 AT ROW 11.5 COL 10
...
DEFINE FRAME FRAME-C
     "bg 8 fg 8" VIEW-AS TEXT
          SIZE 8 BY .63 AT ROW 2 COL 4.5
     "bg 8 fg 8" VIEW-AS TEXT
          SIZE 15 BY 2 AT ROW 1.75 COL 3
          FGCOLOR 10 
...
DEFINE FRAME FRAME-B
     "fg 8" VIEW-AS TEXT
          SIZE 8 BY .63 AT ROW 2.5 COL 8
          FGCOLOR 0 
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 29.5 ROW 8.25
         SIZE 21 BY 6
         FGCOLOR 8 
         TITLE "Frame B".
...
DEFINE FRAME FRAME-A
     "bg8 fg ?" VIEW-AS TEXT
          SIZE 11 BY .63 AT ROW 2.5 COL 6.5
    WITH 1 DOWN KEEP-TAB-ORDER OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 4.5 ROW 2
         SIZE 25.5 BY 4.5
