...
do:
   ...
   */
   ...
   run adedict/_setid.p (INPUT {&OBJ_DOM}, OUTPUT s_DomRecId).
   ---*/
end.
else do:
...
do:
   ...
   if NOT CAN-DO(GATEWAYS, s_DbCache_Type[s_DbCache_ix]) then do:
     ...
     /* If the user tries to connect to other dbs while in the connect 
        box, I'm not sure this will work right!!!  FIX?  
     */
     if answer then
