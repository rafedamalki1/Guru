...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 81.5 BY 15.5.
...
DEFINE FRAME DIALOG-1
     ...
     BTN_SKRIV AT ROW 17.5 COL 38.5
     BTN_EXCEL AT ROW 17.5 COL 53.5
     BTN_AVS AT ROW 17.5 COL 69
     SPACE(0.99) SKIP(0.49)
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   END.
   RUN enable_UI.       
   IF Guru.Konstanter:globforetag = "cSUND" OR Guru.Konstanter:globforetag = "ELPA"  THEN musz = musz.
...
-------------------------------------------------------------*/
   ...
   IF Guru.Konstanter:globforetag = "GKAL" THEN DO:      
      ifil = "\\goliat\DELAD\server\PRO9S\gkal\lonutGKEAB.d".   
   END. 
     
   ELSE IF Guru.Konstanter:globforetag = "LULE" THEN DO:
      ifil = "D:\elpool\DELAD\PRO9s\EXPORT\LON\Lonback\LULEELNAT.d".
   END.      
      
   ELSE IF Guru.Konstanter:globforetag = "celpa" THEN DO:      
      ifil = "f:\elpool\elplo\kalmar\tieto\stanstid.d".
   END.      
   ELSE IF Guru.Konstanter:globforetag = "elpa" THEN DO:
      ifil = "f:\elpool\elplo\sundsvall\stanstidomk.d".
   END.      
