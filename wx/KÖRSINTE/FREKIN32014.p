...
{muswait.i}        
   ...
   /*arvar = 2015.
   filnamn = "\\server05\d\elpool\elplo\kalk\2014\KLG2\skv\Vp1p2 2014.skv".*/
   /*arvar = 2016.
   filnamn = "\\SERVER05\d\elpool\elplo\kalk\2015\KLG2\SKV\Vp1p22015.skv".*/
   arvar = 2017.
   filnamn = "\\SERVER05\d\elpool\elplo\kalk\2016\Excel KLG2\SKV\Vp1p22016.skv".
...
PROCEDURE skapasats_UI:   
   FOR EACH tidin NO-LOCK:
      IF tidin.P1 NE "" THEN DO  TRANSACTION:                                         
         ...
         FREKVENS.LOPNR = tidin.L1
         FREKVENS.FREKOD = " " + tidin.P2
         FREKVENS.FREKNR = tidin.L2
