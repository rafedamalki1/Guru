...
BTN_SKAPEN CMB_AVD RAD_FAST CMB_OMR BRW_EAONR BRW_AONR FILL-IN_AONRS ~
FILL-IN_ORTS BTN_VISA BTN_AVSL 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-VILKETAONR FILL-IN-AONR ~
FILL-IN-DELNR FILL-IN-VISAONR CMB_AVD CMB_OMR FILL-IN-SKP FILL-IN_AONRS ~
FILL-IN_ORTS 
...
DEFINE VARIABLE FILL-IN-VILKETAONR AS CHARACTER FORMAT "X(256)":U 
     VIEW-AS FILL-IN 
     SIZE 68.38 BY 1.38
     FONT 17 NO-UNDO.
...
DEFINE FRAME DIALOG-1
     FILL-IN-VILKETAONR AT ROW 1.42 COL 1.5 NO-LABEL
     FILL-IN-AONR AT ROW 3.25 COL 14.25 COLON-ALIGNED
     FILL-IN-DELNR AT ROW 3.25 COL 29.75 COLON-ALIGNED
     BTN_SKAPEN AT ROW 3.25 COL 41.5
     FILL-IN-VISAONR AT ROW 4.63 COL 47 COLON-ALIGNED NO-LABEL
     FILL-IN-TRAKT AT ROW 4.75 COL 14.25 COLON-ALIGNED
     CMB_OVERUT AT ROW 6 COL 14.25 COLON-ALIGNED
     CMB_AVD AT ROW 6.04 COL 47 COLON-ALIGNED NO-LABEL
     RAD_FAST AT ROW 7.25 COL 1.5 NO-LABEL
     CMB_OMR AT ROW 7.25 COL 47 COLON-ALIGNED NO-LABEL
     BRW_EAONR AT ROW 8.79 COL 1.5
     BRW_AONR AT ROW 8.79 COL 1.5
     FILL-IN-PRISTYP AT ROW 9.63 COL 23.38 COLON-ALIGNED
     CMB_PRISTYP AT ROW 10.83 COL 20.38 COLON-ALIGNED
     FILL-IN-INGAAONR AT ROW 13.04 COL 9 COLON-ALIGNED NO-LABEL
     ...
     FILL-IN-SKP AT ROW 20.83 COL 1 COLON-ALIGNED NO-LABEL
     FILL-IN_AONRS AT ROW 20.88 COL 15 COLON-ALIGNED
     FILL-IN_ORTS AT ROW 20.88 COL 34.25 COLON-ALIGNED
     BTN_VISA AT ROW 22.13 COL 42
     BTN_AVSL AT ROW 22.13 COL 57
     RECT-22 AT ROW 20.63 COL 1.5
     SPACE(10.37) SKIP(1.44)
...
/* SETTINGS FOR DIALOG-BOX DIALOG-1
   NOT-VISIBLE                                                          */
/* BROWSE-TAB BRW_EAONR CMB_OMR DIALOG-1 */
...
/* SETTINGS FOR FILL-IN FILL-IN-VILKETAONR IN FRAME DIALOG-1
   NO-ENABLE ALIGN-L                                                    */
      ...
      IF Guru.Konstanter:globforetag = "SUND" OR Guru.Konstanter:globforetag = "SNAT" OR Guru.Konstanter:globforetag = "MISV" OR Guru.Konstanter:globforetag = "LULE" THEN DO:            
         IF utsokaonr.AONR = "155" THEN DO:
            ...
            IF AVAILABLE utsokaonr THEN DO:
               REPOSITION {&BROWSE-NAME} TO RECID RECID(utsokaonr).
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   FILL-IN-VILKETAONR = "Vilket " + LC(Guru.Konstanter:gaok) + " skall registreras på fram till nu?" 
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-VILKETAONR FILL-IN-AONR FILL-IN-DELNR FILL-IN-VISAONR CMB_AVD 
          CMB_OMR FILL-IN-SKP FILL-IN_AONRS FILL-IN_ORTS 
      WITH FRAME DIALOG-1.
  ENABLE RECT-22 FILL-IN-AONR FILL-IN-DELNR BTN_SKAPEN CMB_AVD RAD_FAST CMB_OMR 
         BRW_EAONR BRW_AONR FILL-IN_AONRS FILL-IN_ORTS BTN_VISA BTN_AVSL 
      WITH FRAME DIALOG-1.
