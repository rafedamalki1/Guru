   ...
   IF b_Field._Fld-stdtype = 41 THEN 
    ...
    ELSE IF b_Field._Fld-stdtype = 40 THEN
        MESSAGE "The DDS hexadecimal data type is not supported"
                              "in Version 7.  This data type will be mapped to an"
                              "ALPHA/CHARACTER data type."   SKIP
       VIEW-AS ALERT-BOX INFORMATION BUTTON OK.
                                                                               
   IF (s_Fld_TypeCode = {&DTYPE_CHARACTER} AND b_Field._Fld-stdtype < 79)
    then
      enable s_fld_case s_fld_var_length with frame newfld.
   ELSE
      disable s_fld_case s_fld_var_length with frame newfld.  
end.
	 ...
	 display "" @ b_Field._Field-Name /* blank instead of ? */
		 ...
		 with frame newfld.
      	 ...
      	 */
      	 ...
      	 find as4dict.p__Field where as4dict.p__Field._File-number = p__File._File-number
