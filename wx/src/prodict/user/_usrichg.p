...
History:
    ...
    12/11/98    mcmann      Added view-as alert-box to uniqueness message
...
DEFINE VAR      l_ifldcnt      AS INT       NO-UNDO.
...
FORM " " SKIP
  ...
  ROW 2 COLUMN 1 SCREEN-LINES - 4 DOWN NO-LABELS NO-ATTR-SPACE
  WIDTH 80 USE-TEXT.

FORM
  _Index._Index-name FORMAT "x(32)"                   NO-LABEL 
  ...
  WITH FRAME idx_top OVERLAY ROW 3 COLUMN 2 SIDE-LABELS ATTR-SPACE NO-BOX.

FORM
  _Index._Index-name FORMAT "x(32)" SKIP
  WITH FRAME idx_lst USE-TEXT
  OVERLAY ROW 4 COLUMN 2 NO-LABELS ATTR-SPACE SCREEN-LINES - 9 DOWN SCROLL 1.
...
FORM
  ...
  ROW 4 COLUMN 38 NO-ATTR-SPACE SCREEN-LINES - 11 DOWN SCROLL 1.
