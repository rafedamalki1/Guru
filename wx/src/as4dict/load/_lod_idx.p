...
/*
   ...
   03/18/97 Change length of index to less than 200 D. McMann 97-03-18-060 
   ...
   04/13/98 Added assignment to _fil-misc1[1] D. McMann 98-03-12-011
...
/* Do a CHKF to see if the file exists already if not a word index */
  ...
  FOR EACH wixf:                   
    ...
    IF lngidx >= 200 AND widx._Wordidx = 0 THEN DO:
