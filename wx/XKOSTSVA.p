/*XKOSTSVA.P. STANSKÖRNING VATTENFALL*/
...
RUN XSTVAVE1.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT (INPUT vkdatum, INPUT Guru.Konstanter:globanv,OUTPUT TABLE pa90fil).
RUN XSTVAFR1.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT (INPUT vkdatum, INPUT Guru.Konstanter:globanv,INPUT TABLE pa90fil).
