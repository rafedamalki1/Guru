...
&Scoped-Define ENABLED-OBJECTS Btn_OK RAD_FAST Btn_Cancel Btn_Help 
...
DEFINE FRAME Dialog-Frame
     ...
     RAD_FAST AT ROW 2.27 COL 4.13 NO-LABEL
     Btn_Cancel AT ROW 2.77 COL 49
     Btn_Help AT ROW 4.77 COL 49
     SPACE(1.13) SKIP(6.37)
...
------------------------------------------------------------------------------*/
  ...
  ENABLE Btn_OK RAD_FAST Btn_Cancel Btn_Help 
      WITH FRAME Dialog-Frame.
