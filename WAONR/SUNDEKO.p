...
END.   /*FOR EACH*/     
/*
FOR EACH ekoforst WHERE ekoforst.EPERSONALKOD = "semos":
    DISPLAY ekoforst.EANTAL ekoforst.EBELOPP  ekoforst.ERESULTENH ekoforst.ELONTILLAGG ekoforst.ELONTILLANTAL. 
END.
*/   
RUN sammut_UI (INPUT 2).
RUN SUNDEKON2.P (INPUT samvar,INPUT vkdatum,INPUT TABLE ekoforst).
