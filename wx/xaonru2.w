...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   /*
   FRAME {&FRAME-NAME}:DEFAULT-BUTTON = BTN_VISA.
   BTN_VISA:DEFAULT = TRUE. 
    */
   ASSIGN
   &Scoped-define BROWSE-NAME BRW_AONR
   utsokaonr.AONR:READ-ONLY IN BROWSE   {&BROWSE-NAME} = TRUE    
   &Scoped-define BROWSE-NAME BRW_VAONR
   valdaao.AONR:READ-ONLY IN BROWSE     {&BROWSE-NAME} = TRUE.
   ASSIGN
   ...
   status-ok = CMB_FAK:ADD-FIRST("Alla").
   status-ok = CMB_FAK:ADD-LAST("Avtal").
   status-ok = CMB_FAK:ADD-LAST("A-contofakt.").
   status-ok = CMB_FAK:ADD-LAST("Takprisfakt.").
   status-ok = CMB_FAK:ADD-LAST("Faktureras ej").
