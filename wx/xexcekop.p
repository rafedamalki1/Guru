...
kommando = "C:\Program\WebClientApps\Elpool i Umeå AB\GuruOnWeb\elpao\" + fnamn.
kommando2 = "C:\Program FILES\WebClientApps\Elpool i Umeå AB\GuruOnWeb\elpaoABCDEFGHIJKLMN\" + fnamn.
...
chExcelApplication:Visible = TRUE.
   ...
   /*chWorkSheet = chExcelApplication:sheets:copy(Sheets("Kabelskåpskort") -after).*/
...
chWorkSheet = chExcelApplication:COPY():Sheets("Kabelskåpskort").*/

      /*
      Sheets("Kabelskåpskort")Copy Before:=Sheets(1).        
