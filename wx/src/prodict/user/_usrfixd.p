...
DEFINE SHARED VARIABLE pik_list  AS CHARACTER EXTENT 0640 NO-UNDO.

/*output:*/
DEFINE SHARED VARIABLE pik_lower AS INTEGER   EXTENT 0640 NO-UNDO.
DEFINE SHARED VARIABLE pik_upper AS INTEGER   EXTENT 0640 NO-UNDO.
