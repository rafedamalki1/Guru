...
DEFINE FRAME Dialog-Frame
    ...
    WITH VIEW-AS DIALOG-BOX KEEP-TAB-ORDER 
         ...
         TITLE "Lönearter kopplat till avtal"
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  RUN enable_UI.
  {FRMSIZEDF.I}
  RUN PERSLARTVISDYN.P PERSISTENT SET bestdynh (INPUT THIS-PROCEDURE, INPUT framesizeh,INPUT TABLE whandltemp).
  RUN skapabrw_UI IN bestdynh (INPUT 1,INPUT 1, TEMP-TABLE koder:DEFAULT-BUFFER-HANDLE).
