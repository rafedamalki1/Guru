...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 82.5 BY 20.5.
...
DEFINE FRAME FRAME-VINST
     ...
     BTN_SKRIV AT ROW 22.54 COL 54.5
     BTN_AVS AT ROW 22.54 COL 70
...
-------------------------------------------------------------*/
   ...
   ELSE DO:   
      IF Guru.Konstanter:appcon THEN DO:
         RUN RATTVAPP2.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT 
         (INPUT pkod,INPUT allval, INPUT TABLE orginaltemp, INPUT TABLE extratidallt, OUTPUT TABLE tidut).   
      END.
      ELSE DO:
         RUN RATTVAPP2.P
         (INPUT pkod,INPUT allval, INPUT TABLE orginaltemp, INPUT TABLE extratidallt, OUTPUT TABLE tidut).   
