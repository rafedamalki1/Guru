...
DEFINE FRAME FRAME-TIDS
     ...
     BTN_SKRIV AT ROW 28.25 COL 77.5
     BTN_AVS AT ROW 28.25 COL 94
...
-------------------------------------------------------------*/
   IF Guru.Konstanter:appcon THEN DO:
      RUN SALMANAP.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT
      (INPUT arnr,INPUT manadnamn,INPUT manadnr,INPUT TABLE tidpers,
       OUTPUT TABLE tidut).
   END.
   ELSE DO:
      RUN SALMANAP.P 
