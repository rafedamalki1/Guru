...
DEFINE SHARED VARIABLEhoppsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE aonrsekvar AS LOGICAL EXTENT 50 NO-UNDO.
...
DEFINE SHARED VARIABLEfaktsekvar AS LOGICAL EXTENT 50 NO-UNDO.

DEFINE SHARED VARIABLE kalk2sekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE mtrlsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLEpersekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLEplansekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLEregsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE tadmsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE tidasekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLEtidbsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE tidosekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE tidrsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLEtidsekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE tidssekvar AS LOGICAL EXTENT 50 NO-UNDO.
DEFINE SHARED VARIABLE tidtsekvar AS LOGICAL EXTENT 50 NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS BTN_PREG BRW_STANS BTN_NVE BTN_NVE-2 ~
FILL-IN_PERSONALPERIOD FILL-IN_AONR FILL-IN_DELNR FILL-IN-STARTDAT ~
FILL-IN-STOPPDAT BTN_FVE BTN_FVE-2 BTN_REG BTN_AVB 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-COLUMN-SCROLLING SIZE 91.5 BY 10.67.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     FILL-IN_PERSONALKOD AT ROW 3.13 COL 16.88 COLON-ALIGNED
     FILL-IN_FORNAMN AT ROW 3.13 COL 34.13 COLON-ALIGNED
     FILL-IN_EFTERNAMN AT ROW 3.13 COL 61.75 COLON-ALIGNED
     FILL-IN-AR AT ROW 4.38 COL 3 COLON-ALIGNED NO-LABEL
     FILL-IN-MANAD AT ROW 4.38 COL 12.25 COLON-ALIGNED NO-LABEL
     CMB_BEF AT ROW 4.38 COL 52.63 COLON-ALIGNED
     stanstid.FELTXT AT ROW 5.71 COL 52.63 COLON-ALIGNED
          LABEL "Feltext" FORMAT "X(68)"
          VIEW-AS FILL-IN 
          SIZE 37.75 BY .92
          FGCOLOR 12 FONT 11
     BTN_PREG AT ROW 5.75 COL 94
     BRW_STANS AT ROW 6.75 COL 1.5
     BTN_KONTROLL AT ROW 6.83 COL 94
     FILL-IN-REGIS AT ROW 6.96 COL 4.5 COLON-ALIGNED NO-LABEL
     FILL-IN_NAMN AT ROW 6.96 COL 24 COLON-ALIGNED HELP
          "ANGE ORAGNISTIONENSBENÄMNING" NO-LABEL
     FILL-IN_EFTERNAMN-2 AT ROW 6.96 COL 45.5 COLON-ALIGNED NO-LABEL
     BTN_GOD AT ROW 7.96 COL 94
     BTN_TJRESA AT ROW 9.04 COL 94
     FILL-IN_VECKONUMMER AT ROW 10 COL 33.63 COLON-ALIGNED
     BTN_BERED AT ROW 10.17 COL 94
     BTN_RES AT ROW 11.25 COL 94
     BTN_VISA AT ROW 12.33 COL 94
     RAD_ALLVAL AT ROW 13.42 COL 5.25 NO-LABEL
     CMB_PRISTYP AT ROW 14.5 COL 92 COLON-ALIGNED
     FILL-IN-PRISTYP AT ROW 15 COL 93 COLON-ALIGNED
     FILL-IN-PRIS AT ROW 15.58 COL 95 COLON-ALIGNED
     FILL-IN-VALFA AT ROW 17.54 COL 58.25 COLON-ALIGNED NO-LABEL
     BTN_NVE AT ROW 18.63 COL 72.13
     BTN_NVE-2 AT ROW 18.63 COL 91.13
     FILL-IN_PERSONALPERIOD AT ROW 18.96 COL 22.5 COLON-ALIGNED AUTO-RETURN 
     FILL-IN_AONR AT ROW 18.96 COL 34.75 COLON-ALIGNED AUTO-RETURN 
     FILL-IN_DELNR AT ROW 18.96 COL 49.25 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-STARTDAT AT ROW 19 COL 60.13 COLON-ALIGNED AUTO-RETURN 
     FILL-IN-STOPPDAT AT ROW 19 COL 79.13 COLON-ALIGNED AUTO-RETURN 
     FILL-IN_VIBEFATTNING AT ROW 19.13 COL 74.13 COLON-ALIGNED HELP
          "BEFATTNINGSKOD"
     BTN_FVE AT ROW 19.46 COL 72.13
     BTN_FVE-2 AT ROW 19.46 COL 91.13
     BTN_REG AT ROW 20.75 COL 79
     BTN_AVB AT ROW 20.75 COL 94
     "Person som tidskrivs:" VIEW-AS TEXT
          SIZE 45.75 BY 1.08 AT ROW 2 COL 1.5
          FONT 17
     "Period registrering:" VIEW-AS TEXT
          SIZE 20.63 BY .88 AT ROW 17.96 COL 1.5
    WITH 1 DOWN NO-BOX OVERLAY 
         SIDE-LABELS NO-UNDERLINE THREE-D 
         AT COL 1 ROW 1
         SIZE 107.88 BY 21.29.
...
/* SETTINGS FOR FRAME DEFAULT-FRAME
                                                                        */
/* BROWSE-TAB BRW_STANS BTN_PREG DEFAULT-FRAME */
...
ON ROW-LEAVE OF BRW_STANS IN FRAME DEFAULT-FRAME
DO:
   RUN visa_UI.   
   ASSIGN
...
ON CHOOSE OF BTN_REG IN FRAME DEFAULT-FRAME /* OK */
DO:
   {muswait.i} 
   RUN regstart_UI.
   {musarrow.i}    
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BTN_REG C-Win
ON GO OF BTN_REG IN FRAME DEFAULT-FRAME /* OK */
DO:
   RETURN.
END.
...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _CONTROL BTN_REG C-Win
ON LEAVE OF BTN_REG IN FRAME DEFAULT-FRAME /* OK */
DO:
   musz = musz.    
END.
...
DO:
   ...
   END.   
   ELSE IF Guru.Konstanter:globforetag = "SUND" OR Guru.Konstanter:globforetag = "SNAT" THEN ASSIGN energiavt = TRUE.
...
------------------------------------------------------------------------------*/
  ...
  IF AVAILABLE stanstid THEN 
    DISPLAY stanstid.FELTXT 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
  ENABLE BTN_PREG BRW_STANS BTN_NVE BTN_NVE-2 FILL-IN_PERSONALPERIOD 
         FILL-IN_AONR FILL-IN_DELNR FILL-IN-STARTDAT FILL-IN-STOPPDAT BTN_FVE 
         BTN_FVE-2 BTN_REG BTN_AVB 
      WITH FRAME DEFAULT-FRAME IN WINDOW C-Win.
