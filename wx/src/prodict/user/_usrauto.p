...
DO FOR DICTDB._Db:
  ...
  FORM
    ...
    " Enter Physical Database Name below:" SKIP
    _Db-addr FORMAT "x(51)" LABEL "   "    SKIP
    " Enter CONNECT-statement parameters for auto-connect below:" SKIP
    args[1] FORMAT "x(51)" LABEL "   " SKIP
    args[2] FORMAT "x(51)" LABEL "   " SKIP
    args[3] FORMAT "x(51)" LABEL "   " SKIP
    args[4] FORMAT "x(51)" LABEL "   " SKIP
    args[5] FORMAT "x(51)" LABEL "   " SKIP
    " When the above-named database is called for in a PROGRESS"    SKIP
    " program, and PROGRESS sees that the above-named database is"  SKIP
    " not connected, but the current database is connected, the"    SKIP
    " parameters stored here will be used for an ~"auto-connect~"." SKIP
    " NOTE:   For Non-PROGRESS databases, use the DataServer "      SKIP
