...
&Scoped-define QUERY-STRING-BRW_ANST FOR EACH ANSTFORMTAB NO-LOCK ~
...
&Scoped-Define ENABLED-OBJECTS RECT-48 RECT-49 RECT-50 RECT-51 BRW_ANST ~
TOG_ERSATTNING TOG_LONTILL TOG_OBAVTAB TOG_OBTAB TOG_ORDARB TOG_OVERAVTAB ~
TOG_OVERKOD BTN_BORT FILL-IN-BORTAV TOG_OVERTIDTAB TOG_RESTIDTAB ~
FILL-IN-NAMN TOG_UTRTAB FILL-IN-NYTTAV FILL-IN-FRAN TOG_UTRYCKNING BTN_KOP ~
TOG_BYTPERS FILL-IN-FRANBYT FILL-IN-NYTTAVBYT BTN_BYT FILL-IN-FRANBYTN ~
FILL-IN-NYTTANSTALL BTN_BYTNAMN BTN_AVSL 
...
TOG_OVERTIDTAB TOG_RESTIDTAB FILL-IN-NAMN TOG_UTRTAB FILL-IN-NYTTAV ~
FILL-IN-FRAN TOG_UTRYCKNING TOG_BYTPERS FILL-IN-FRANBYT FILL-IN-NYTTAVBYT ~
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS NO-COLUMN-SCROLLING SIZE 74 BY 8.17.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME FRAME-A
     BRW_ANST AT ROW 1.25 COL 3.5
     TOG_ERSATTNING AT ROW 1.5 COL 79
     TOG_LONTILL AT ROW 2.75 COL 79
     TOG_OBAVTAB AT ROW 3.88 COL 79
     TOG_OBTAB AT ROW 5.04 COL 79
     TOG_ORDARB AT ROW 6.29 COL 79
     TOG_OVERAVTAB AT ROW 7.54 COL 79
     TOG_OVERKOD AT ROW 8.88 COL 79
     BTN_BORT AT ROW 9.88 COL 34.63
     FILL-IN-BORTAV AT ROW 10 COL 22.5 COLON-ALIGNED
     TOG_OVERTIDTAB AT ROW 10.17 COL 79
     TOG_RESTIDTAB AT ROW 11.29 COL 79
     FILL-IN-NAMN AT ROW 11.96 COL 22.5 COLON-ALIGNED
     TOG_UTRTAB AT ROW 12.63 COL 79
     FILL-IN-NYTTAV AT ROW 13.63 COL 44 COLON-ALIGNED
     FILL-IN-FRAN AT ROW 13.75 COL 22.5 COLON-ALIGNED
     TOG_UTRYCKNING AT ROW 13.96 COL 79
     BTN_KOP AT ROW 15 COL 24.5
     TOG_BYTPERS AT ROW 15.29 COL 79
     FILL-IN-FRANBYT AT ROW 17.46 COL 22.5 COLON-ALIGNED
     FILL-IN-NYTTAVBYT AT ROW 17.46 COL 44 COLON-ALIGNED
     BTN_BYT AT ROW 18.75 COL 24.5
     FILL-IN-FRANBYTN AT ROW 21.46 COL 22.5 COLON-ALIGNED
     FILL-IN-NYTTANSTALL AT ROW 23.08 COL 22.5 COLON-ALIGNED
     BTN_BYTNAMN AT ROW 24.5 COL 24
     BTN_AVSL AT ROW 27.25 COL 88.5
     RECT-48 AT ROW 11.63 COL 2.5
     RECT-49 AT ROW 9.46 COL 2.88
     RECT-50 AT ROW 16.83 COL 2.5
     RECT-51 AT ROW 20.63 COL 3
...
/* SETTINGS FOR FRAME FRAME-A
   FRAME-NAME                                                           */
/* BROWSE-TAB BRW_ANST RECT-51 FRAME-A */
...
"ANSTFORMTAB.ANSTALLNING" ? "x(40)" "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" "" "" "" "" "" 0 no 0 no no
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
  ...
  brec = RECID(ANSTFORMTAB).
  /*släck möjligheter tills vidare*/
  TOG_BYTPERS:HIDDEN = TRUE.
...
------------------------------------------------------------------------------*/
  DISPLAY TOG_ERSATTNING TOG_LONTILL TOG_OBAVTAB TOG_OBTAB TOG_ORDARB 
          TOG_OVERAVTAB TOG_OVERKOD FILL-IN-BORTAV TOG_OVERTIDTAB TOG_RESTIDTAB 
          FILL-IN-NAMN TOG_UTRTAB FILL-IN-NYTTAV FILL-IN-FRAN TOG_UTRYCKNING 
          TOG_BYTPERS FILL-IN-FRANBYT FILL-IN-NYTTAVBYT FILL-IN-FRANBYTN 
          FILL-IN-NYTTANSTALL 
      WITH FRAME FRAME-A IN WINDOW WINDOW-1.
  ENABLE RECT-48 RECT-49 RECT-50 RECT-51 BRW_ANST TOG_ERSATTNING TOG_LONTILL 
         TOG_OBAVTAB TOG_OBTAB TOG_ORDARB TOG_OVERAVTAB TOG_OVERKOD BTN_BORT 
         FILL-IN-BORTAV TOG_OVERTIDTAB TOG_RESTIDTAB FILL-IN-NAMN TOG_UTRTAB 
         FILL-IN-NYTTAV FILL-IN-FRAN TOG_UTRYCKNING BTN_KOP TOG_BYTPERS 
         FILL-IN-FRANBYT FILL-IN-NYTTAVBYT BTN_BYT FILL-IN-FRANBYTN 
         FILL-IN-NYTTANSTALL BTN_BYTNAMN BTN_AVSL 
      WITH FRAME FRAME-A IN WINDOW WINDOW-1.
...
END.
/* vill inte att det ska finnas möjlighet att flytta personerna i samband med kopiering av ett avtal till ett nytt 
IF TOG_BYTPERS = TRUE THEN DO TRANSACTION:
   FIND FIRST ANSTFORMTAB WHERE ANSTFORMTAB.KOD = FILL-IN-FRAN NO-LOCK NO-ERROR.
   OPEN QUERY persq FOR EACH PERSONALTAB WHERE PERSONALTAB.ANSTALLNING = ANSTFORMTAB.ANSTALLNING
   NO-LOCK.
