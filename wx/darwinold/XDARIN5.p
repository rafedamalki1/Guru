/*XDARIN5.p INLÄSNING AV MODERDARS störningsrapporter*/       
...
PROCEDURE in_UI: 
   ...
   filnamn = "\\pc112\delad\elpool\elpNJ\DARWIN\SVEN\sydkraft\stor2.txt".
   RUN PROVAG.P.
   ASSIGN
 ...
 *       END.*/   
   END.
   OUTPUT TO "\\pc112\delad\elpool\elpNJ\DARWIN\SVEN\sydkraft\FELOVRIGT.txt" 
   ...
   END.
   OUTPUT CLOSE.    
   OUTPUT TO "\\pc112\delad\elpool\elpNJ\DARWIN\SVEN\sydkraft\FELTID.txt" 
   APPEND CONVERT TARGET "iso8859-1" SOURCE "iso8859-1" 
   NO-ECHO.
