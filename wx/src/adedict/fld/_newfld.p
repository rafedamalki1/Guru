...
Date Created: 02/05/92
    Modified: 12/11/98 Check for duplicate order numbers, warn and prevent.
   ...
   do ON ERROR UNDO, LEAVE  ON STOP UNDO, LEAVE:
	 ...
	 b_Field._Decimals = b_Field._Fld-stlen.
      ...
      /*-------------------------
      	 ...
      	 find FIRST _Field where _Field._File-recid = s_DomRecId AND
...
/* FIX? for domains do we check the _Field or _Domain table */
find _File "_Field".
