...
&ANALYZE-SUSPEND _UIB-CODE-BLOCK _DISPLAY-FIELDS BRW_UT WINDOW-2 _STRUCTURED
  QUERY BRW_UT NO-LOCK DISPLAY
      tidut.ut FORMAT "X(132)":U WIDTH 112
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 117.5 BY 26.
...
DEFINE FRAME FRAME-VINST
     ...
     BTN_SKRIV AT ROW 28 COL 88.5
     BTN_AVS AT ROW 28 COL 105
...
"tidut.ut" ? ? "character" ? ? ? ? ? ? no ? no no "112" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BRW_UT */
&ANALYZE-RESUME
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   RUN viskoff_UI IN kundoffproch (INPUT valkalknr,INPUT TABLE kund_mtrl,OUTPUT TABLE tidut).        
