...
Customer.Name Customer.City Customer.Address Customer.Phone 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS NO-COLUMN-SCROLLING SIZE 89.13 BY 6.27.


/* ************************  Frame Definitions  *********************** */

DEFINE FRAME DEFAULT-FRAME
     BRW_STANS AT ROW 1.91 COL 4
     BTN_AVB AT ROW 15.59 COL 43.88
     RECT-36 AT ROW 15.23 COL 27.88
     "när jag byter från rad 1 till rad 2 med tab tangenten vill jag hamna i fältet" VIEW-AS TEXT
          SIZE 91 BY 1 TOOLTIP "Hur skall det finnas direktkopplingar till andra funktioner?" AT ROW 18.36 COL 2
     "aonr" VIEW-AS TEXT
          SIZE 91 BY 1 AT ROW 19.64 COL 2
