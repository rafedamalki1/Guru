...
FORM
  ...
  WITH FRAME working OVERLAY
  ROW 4 CENTERED USE-TEXT SIDE-LABELS ATTR-SPACE.
...
DO ON STOP UNDO, LEAVE:
    ...
    */
	  ...
	  WHEN    "DESCRIPTION"    THEN DO: 
	      IF LENGTH(iarg) < 51 THEN wfil._Desc = iarg.
	      ELSE DO:
	  ...
	  WHEN    "FLD-NAMES-LIST"  
                        OR WHEN    "AS400-FLAGS"    THEN wfil._Fil-Misc2[4] = iarg.
	  ...
	  WHEN    "DESC"      OR WHEN "DESCRIPTION" THEN DO: 
	      IF LENGTH(iarg) < 51 THEN wfld._Desc = iarg.
	      ELSE DO:
	  ...
	  WHEN    "VIEW-AS"                THEN DO: 
	       ...
	       ELSE DO:
                    ...
                    END.
	  WHEN    "HELP"                   THEN DO: 
	      IF LENGTH(TRIM(iarg)) < 129 THEN wfld._Help = TRIM(iarg).
	      ELSE DO:
                            ASSIGN lfld = "Help"
	  ...
	  WHEN    "CASE-SENSITIVE"         THEN wfld._Fld-case      = 
                    ...
                    WHEN    "FLD-STLEN"              
                        OR WHEN "FOREIGN-SIZE"           THEN wfld._Fld-stlen     = INTEGER(iarg).
