...
DEFINE INPUT PARAMETER tid5 AS DECIMAL NO-UNDO.
DEFINE INPUT PARAMETER regstart AS DECIMAL NO-UNDO.
DEFINE INPUT PARAMETER regslut AS DECIMAL NO-UNDO.
DEFINE OUTPUT PARAMETER rmal AS CHARACTER NO-UNDO.
...
&Scoped-Define ENABLED-OBJECTS RECT-22 CMB_AVD FILL-IN-AONR BTN_SKAPEN ~
RAD_FAST CMB_OMR FILL-IN-DELNR FILL-IN_RESMAL FILL-IN_AONRS FILL-IN_ORTS ~
BTN_VISA BTN_AVSL 
&Scoped-Define DISPLAYED-OBJECTS FILL-IN-VISAONR FILL-IN-VALAONR CMB_AVD ~
FILL-IN-AONR CMB_OMR FILL-IN-DELNR FILL-IN_RESMAL FILL-IN-SKP FILL-IN_AONRS ~
FILL-IN_ORTS 
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 60 BY 11.13.
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS NO-COLUMN-SCROLLING SIZE 60 BY 11.13
...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-ROW-MARKERS SIZE 43 BY 7.25
...
DEFINE FRAME DIALOG-1
     FILL-IN-VISAONR AT ROW 1.25 COL 94 COLON-ALIGNED NO-LABEL
     FILL-IN-VALAONR AT ROW 1.5 COL 20.5 NO-LABEL
     CMB_AVD AT ROW 2.25 COL 94 COLON-ALIGNED NO-LABEL
     FILL-IN-AONR AT ROW 3 COL 18.5 COLON-ALIGNED
     BTN_SKAPEN AT ROW 3 COL 32.5
     RAD_FAST AT ROW 3.25 COL 50.5 NO-LABEL
     CMB_OMR AT ROW 3.25 COL 94 COLON-ALIGNED NO-LABEL
     FILL-IN-DELNR AT ROW 4.25 COL 18.5 COLON-ALIGNED
     BRW_EAONR AT ROW 4.5 COL 57.5
     BRW_AONR AT ROW 4.5 COL 57.5
     FILL-IN-TRAKT AT ROW 5.5 COL 18.5 COLON-ALIGNED
     CMB_OVERUT AT ROW 6.75 COL 18.5 COLON-ALIGNED
     FILL-IN-OVER AT ROW 7.75 COL 57 COLON-ALIGNED HELP
          "ÖVERTID = Ö, KOMP = K, INGEN ERSÄTTNING = I"
     FILL-IN-OTBRD AT ROW 7.96 COL 18.5 COLON-ALIGNED
     FILL-IN_RESMAL AT ROW 9.25 COL 18.5 COLON-ALIGNED
     FILL-IN-PRIS AT ROW 9.75 COL 60.5 COLON-ALIGNED
     BRW_OTBRD AT ROW 10.75 COL 13.5
     FILL-IN-PRISTYP AT ROW 11.75 COL 45.5 COLON-ALIGNED
     CMB_PRISTYP AT ROW 13.75 COL 42.63 COLON-ALIGNED
     FILL-IN-SKP AT ROW 16.17 COL 56.25 COLON-ALIGNED NO-LABEL
     FILL-IN_AONRS AT ROW 16.17 COL 70.75 COLON-ALIGNED
     FILL-IN_ORTS AT ROW 16.17 COL 93.75 COLON-ALIGNED
     BTN_VISA AT ROW 18 COL 88.5
     BTN_AVSL AT ROW 18 COL 103.5
     RECT-22 AT ROW 16 COL 57.5
     SPACE(0.62) SKIP(2.03)
...
/* SETTINGS FOR DIALOG-BOX DIALOG-1
   NOT-VISIBLE                                                          */
/* BROWSE-TAB BRW_EAONR FILL-IN-DELNR DIALOG-1 */
/* BROWSE-TAB BRW_AONR BRW_EAONR DIALOG-1 */
/* BROWSE-TAB BRW_OTBRD FILL-IN-PRIS DIALOG-1 */
ASSIGN 
...
"otidbeordtemp.PERSONALKOD" "Enhet" ? "character" ? ? ? ? ? ? no ? no no ? yes no no "U" "" ""
     _FldNameList[2]   > Temp-Tables.otidbeordtemp.FORNAMN
"otidbeordtemp.FORNAMN" "Förnamn" "x(256)" "character" ? ? ? ? ? ? no ? no no "10" yes no no "U" "" ""
     _FldNameList[3]   > Temp-Tables.otidbeordtemp.EFTERNAMN
"otidbeordtemp.EFTERNAMN" "Efternamn" "x(256)" "character" ? ? ? ? ? ? no ? no no "24.25" yes no no "U" "" ""
     _Query            is OPENED
*/  /* BROWSE BRW_OTBRD */
&ANALYZE-RESUME
...
DO: 
   ...
   IF Guru.Konstanter:globforetag = "SUND" OR Guru.Konstanter:globforetag = "SNAT" OR Guru.Konstanter:globforetag = "MISV" OR Guru.Konstanter:globforetag = "ELPA" THEN DO:
      ...
      IF FILL-IN-OTBRD NE ""  THEN DO:      
         ...
         IF NOT AVAILABLE otidbeordtemp  THEN DO:
            ...
            APPLY "ENTRY" TO FILL-IN-OTBRD IN FRAME {&FRAME-NAME}.
            musz = TRUE.
         END.
      ...
      ELSE DO:               
         IF tid5 > regslut  THEN DO:                       
            ...
            END.
         END.
         ELSE IF tid5 LE regslut  THEN DO:                       
            IF FILL-IN-OTBRD NE "" THEN DO:
               MESSAGE "Övertidsbeordrare skall skall bara användas för övertid"  VIEW-AS ALERT-BOX. 
               APPLY "ENTRY" TO FILL-IN-OTBRD IN FRAME {&FRAME-NAME}.
               musz = TRUE.
   ...
   ELSE DO:           
      ...
      rmal = SUBSTRING(FILL-IN_RESMAL,1,158). 
      IF Guru.Konstanter:globforetag = "SUND" OR Guru.Konstanter:globforetag = "SNAT" OR Guru.Konstanter:globforetag = "MISV" OR Guru.Konstanter:globforetag = "ELPA" THEN DO:
         SUBSTRING(rmal,159,6) = SUBSTRING(FILL-IN-OTBRD,1,6).
      END.            
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   FRAME {&FRAME-NAME}:TITLE = "Välj " + LC(Guru.Konstanter:gaol) + " för övertiden"
   ...
   FILL-IN-VALAONR = "Välj " + LC(Guru.Konstanter:gaok) + " för övertiden"
   ...
   IF Guru.Konstanter:globforetag = "SUND" OR Guru.Konstanter:globforetag = "SNAT" OR Guru.Konstanter:globforetag = "MISV" OR Guru.Konstanter:globforetag = "ELPA" THEN DO:               
      ...
      END.     
      OPEN QUERY BRW_OTBRD FOR EACH otidbeordtemp WHERE otidbeordtemp.AKTIV = TRUE NO-LOCK.   
...
------------------------------------------------------------------------------*/
  DISPLAY FILL-IN-VISAONR FILL-IN-VALAONR CMB_AVD FILL-IN-AONR CMB_OMR 
          FILL-IN-DELNR FILL-IN_RESMAL FILL-IN-SKP FILL-IN_AONRS FILL-IN_ORTS 
      WITH FRAME DIALOG-1.
  ENABLE RECT-22 CMB_AVD FILL-IN-AONR BTN_SKAPEN RAD_FAST CMB_OMR FILL-IN-DELNR 
         FILL-IN_RESMAL FILL-IN_AONRS FILL-IN_ORTS BTN_VISA BTN_AVSL 
      WITH FRAME DIALOG-1.
