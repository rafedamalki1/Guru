...
DEFINE FRAME FRAME-VINST
     ...
     BTN_SKRIV AT ROW 27.96 COL 94.5
...
-------------------------------------------------------------*/   
   ...
   IF Guru.Konstanter:appcon THEN DO:
      RUN OMRPLUTFAPPC.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT
      (INPUT planvar,INPUT franar,
      INPUT monpris,INPUT xtypmtrl,INPUT TABLE tempupp,
      INPUT TABLE omrkonto, OUTPUT TABLE tidut, INPUT Guru.Konstanter:globforetag).
   END.
   ELSE DO:
      RUN OMRPLUTFAPPC.P
      (INPUT planvar,INPUT franar,
