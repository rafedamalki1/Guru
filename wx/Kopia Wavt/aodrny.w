...
DEFINE FRAME DIALOG-3
     ...
     RECT-11 AT ROW 2 COL 2.5
     RECT-12 AT ROW 10 COL 2.5
     SPACE(4.99) SKIP(0.54)
...
------------------------------------------------------------------------------*/
  IF AVAILABLE AODRIFT THEN 
    DISPLAY AODRIFT.AONR AODRIFT.DELNR AODRIFT.OVLAPP 
      WITH FRAME DIALOG-3.
  ENABLE RECT-11 RECT-12 AODRIFT.AONR AODRIFT.DELNR AODRIFT.OVLAPP BTN_OK 
         BTN_AVBRYT 
      WITH FRAME DIALOG-3.
