...
DO WHILE AVAILABLE(PERSONALTAB):
   ...
   TIDREGITAB.PERSONALKOD = PERSONALTAB.PERSONALKOD AND TIDREGITAB.aonr = "39001" AND delnr = 0 AND  
   TIDREGITAB.GODKAND BEGINS "G" AND TIDREGITAB.VECKOKORD NE "" AND
...
RUN SUNDEKO2.P (INPUT vkdatum,INPUT TABLE ekoforst).
