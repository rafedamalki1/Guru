...
-------------------------------------------------------------*/
   ...
   DO TRANSACTION:     
      ...
      ELSE DO:   
         ...
         CREATE tidut. 
         ASSIGN  
         SUBSTRING(tidut.UT,1) = "LISTA ÖVER ARTIKLAR UPPLAGDA I DEPÅ " + dbenamning.      
         CREATE tidut.   
         ASSIGN
         SUBSTRING(tidut.UT,1) = "SOM EJ GICK ATT BYTA TILL LEVERANTÖR"
...
-------------------------------------------------------------*/
   ...
   IF raknare = 0 THEN DO:
      ...
      CREATE tidut.
      SUBSTRING(tidut.UT,1) = "ALLA ARTIKLAR FANNS HOS LEVERANTÖR " + levtemp.LEVNAMN.
   END.                                                                  
END PROCEDURE.
