...
DEFINE VARIABLE bodydoc AS CHARACTER INITIAL "Berlista1" LABEL "Berlista1" NO-UNDO.
...
FOR EACH tidut NO-LOCK: 
   ...
   ELSE IF Guru.Konstanter:globforetag = "UMEA" THEN DO:
      IF SUBSTRING(tidut.UT,1,21) = "Materielspecifikation" THEN DO: 
         boldblack = TRUE.      
      END.
   END.
   ELSE DO:
   ...
   END.
   /*Rubrik*/
   IF SUBSTRING(tidut.UT,1,13) = "Materiellista" THEN DO: 
      boldblack = TRUE.      
   END.
...
IF Guru.GlobalaVariabler:plusaonr = "" OR Guru.GlobalaVariabler:plusaonr = ? THEN DO:
   utfil = utfil + STRING(TIME) + "ber1.htm".
END. 
ELSE DO:
   utfil = utfil + TRIM (Guru.GlobalaVariabler:plusaonr) + TRIM(STRING(Guru.GlobalaVariabler:plusdnr,Guru.Konstanter:varforetypchar[1])) + STRING(TIME) + "ber1.htm".
END.
...
PROCEDURE logga_UI.
   ...
   /*
   ELSE IF Guru.Konstanter:globforetag = "cELPA" {GLOBVES.I} THEN DO:
      IF counter = 1 THEN DO:         
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src='" + logga + "' border='0' width='182' height='44' alt='Vattenfall'></td><td class='header' width='370'></td>".
      END.
      ELSE DO:
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src='" + logga + "' border='0' width='182' height='44' alt='Vattenfall'></td><td class='header' width='300'></td><td width='70'><pre>sid " + STRING(counter) + "</pre></td>".
      END.
      CREATE htmlut.
      ASSIGN htmlut.UT = "</tr></table>".
   END.
   ELSE IF Guru.Konstanter:globforetag = "TRAS" THEN DO:
      IF counter = 1 THEN DO:         
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src='" + logga + "' border='0' width='137' height='50' alt='Trässmans'></td><td class='header' width='370'></td>".
      END.
      ELSE DO:
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src='" + logga + "' border='0' width='137' height='50' alt='Trässmans'></td><td class='header' width='300'></td><td width='70'><pre>sid " + STRING(counter) + "</pre></td>".
      END.
      CREATE htmlut.
      ASSIGN htmlut.UT = "</tr></table>".
   END.
   ELSE IF Guru.Konstanter:globforetag = "ALTE" OR Guru.Konstanter:globforetag = "CELPA" THEN DO:     
      IF counter = 1 THEN DO:         
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='50' alt='Alteco_RGB'></td><td class='header' width='370'></td>".
      END.
      ELSE DO:
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='50' alt='Alteco_RGB'></td><td class='header' width='300'></td><td width='70'><pre>sid " + STRING(counter) + "</pre></td>".
      END.
      CREATE htmlut.
      ASSIGN htmlut.UT = "</tr></table>".
   END.
   ELSE IF Guru.Konstanter:globforetag = "PICA" THEN DO:     
      IF counter = 1 THEN DO:         
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='60' alt='PICAB'></td><td class='header' width='370'></td>".
      END.
      ELSE DO:
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='60' alt='PICAB'></td><td class='header' width='300'></td><td width='70'><pre>sid " + STRING(counter) + "</pre></td>".
      END.
      CREATE htmlut.
      ASSIGN htmlut.UT = "</tr></table>".
   END.
   ELSE IF Guru.Konstanter:globforetag = "CELPA" THEN DO:     
      IF counter = 1 THEN DO:         
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='60' alt='ELPOOL'></td><td class='header' width='370'></td>".
      END.
      ELSE DO:
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='60' alt='ELPOOL'></td><td class='header' width='300'></td><td width='70'><pre>sid " + STRING(counter) + "</pre></td>".
      END.
      CREATE htmlut.
      ASSIGN htmlut.UT = "</tr></table>".
   END.
   ELSE IF Guru.Konstanter:globforetag = "ELTE" OR Guru.Konstanter:globforetag = "CELPA" THEN DO:     
      IF counter = 1 THEN DO:         
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='60' alt='ELTEL'></td><td class='header' width='370'></td>".
      END.
      ELSE DO:
         CREATE htmlut.
         ASSIGN htmlut.UT = "<table width='600'><tr><td width='230'><img align='left' src=""" + logga + """ border='0' width='137' height='60' alt='ELTEL'></td><td class='header' width='300'></td><td width='70'><pre>sid " + STRING(counter) + "</pre></td>".
      END.
      CREATE htmlut.
      ASSIGN htmlut.UT = "</tr></table>".
   END.
