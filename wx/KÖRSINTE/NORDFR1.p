...
IF OPSYS = "MSDOS" OR OPSYS = "WIN32" THEN DO:
  IF Guru.Konstanter:globforetag = "MSK" THEN DO:
     INPUT FROM G:\plusd\atr\export\fransu.d NO-ECHO.
  END.    
  ELSE IF Guru.Konstanter:globforetag = "NORD" THEN DO:
...
IF OPSYS = "MSDOS" OR OPSYS = "WIN32" THEN DO:   
  IF Guru.Konstanter:globforetag = "NORD" THEN DO:
     INPUT FROM P:\progress\franfel.d NO-ECHO.
  END.   
  ELSE DO:
   ...
   DO WHILE AVAILABLE(TIDREGITAB):         
      ...
      IF krav = 0 THEN DO:  
	     ...
	     del1 = FVARO.DEL.   /* ti-timmar pr-procent he-heldag */
            FIND LAST franvaro WHERE franvaro.PERSONNUMMER = pnr AND
	     ...
	     USE-INDEX franvaro EXCLUSIVE-LOCK NO-ERROR.
	        ...
	        END.    	    
	        CREATE franvaro.
	        ASSIGN franvaro.PERSONNUMMER = pnr franvaro.AONR = onr2
	     ...
	     END.
            ...
            IF del1 = FALSE AND franvaro.TIMMAR > 0 THEN DO:
               CREATE frfel.
               ASSIGN frfel.PERSONNUMMER = franvaro.PERSONNUMMER frfel.AONR = franvaro.AONR  
...
END.       
DO TRANSACTION:
   FIND FIRST franvaro WHERE franvaro.PERSONNUMMER = " " OR franvaro.PERSONNUMMER =
   "000000-0000" USE-INDEX franvaro EXCLUSIVE-LOCK NO-ERROR.
   IF AVAILABLE franvaro THEN DELETE franvaro.
END.
REPEAT TRANSACTION:
   FIND NEXT franvaro WHERE franvaro.PERSONNUMMER = " " OR franvaro.PERSONNUMMER =
    "000000-0000"  USE-INDEX franvaro EXCLUSIVE-LOCK NO-ERROR.
...
IF OPSYS = "MSDOS" OR OPSYS = "WIN32" THEN DO:  
   IF Guru.Konstanter:globforetag = "MSK" THEN DO:
      OUTPUT TO G:\plusd\atr\export\fransu.d NO-ECHO.
   END.    
   ELSE IF Guru.Konstanter:globforetag = "NORD" THEN DO:
...
IF OPSYS = "MSDOS" OR OPSYS = "WIN32" THEN DO:  
   IF Guru.Konstanter:globforetag = "NORD" THEN DO:
      OUTPUT TO P:\progress\franfel.d NO-ECHO.
   END.   
   ELSE DO:
