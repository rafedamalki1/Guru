...
RESTIDTAB.KOD = ANSTFORMTAB.KOD AND RESTIDTAB.ENFL = "flbil" AND 
...
ELSE DO:
   IF rslutsek > stop1 AND rslutsek le stop2 THEN DO:
      ...
      SUBSTRING(tidbuff.PROGRAM,1,158) = "RESTID3" + STRING(TODAY) + STRING(TIME,"HH:MM") + Guru.Konstanter:globanv
