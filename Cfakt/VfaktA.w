...
/* _UIB-CODE-BLOCK-END */
&ANALYZE-RESUME
    WITH NO-LABELS NO-COLUMN-SCROLLING SIZE 92.5 BY 26.25.
...
IF SESSION:DISPLAY-TYPE = "GUI":U THEN
  CREATE WINDOW WINDOW-2 ASSIGN
         HIDDEN             = YES
         TITLE              = "Visning av faktura uppläggning"
         HEIGHT             = 28.42
         WIDTH              = 94
         MAX-HEIGHT         = 28.42
         MAX-WIDTH          = 94
...
DO ON ERROR   UNDO MAIN-BLOCK, LEAVE MAIN-BLOCK
   ...
   {muswait.i}     
   {ALLSTARTDYN.I} 
   RUN visfaktplan_UI IN fakthmth (INPUT infakplannr, OUTPUT TABLE tidut).     
