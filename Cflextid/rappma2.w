...
DEFINE FRAME FRAME-TIDS
     ...
     BTN_NAAVB AT ROW 28 COL 81
     BTN_SKRIV AT ROW 28 COL 96
...
-------------------------------------------------------------*/
   IF Guru.Konstanter:appcon THEN DO:
      RUN RAPPMA2A.P ON Guru.Konstanter:apphand TRANSACTION DISTINCT
      (INPUT tidpers.PERSONALKOD,INPUT arnr,INPUT manad,
       INPUT manadnamn,INPUT manadnr,OUTPUT TABLE tidut).
   END.
   ELSE DO:
      RUN RAPPMA2A.P 
      (INPUT tidpers.PERSONALKOD,INPUT arnr,INPUT manad,
