 /* G:\PRO9S\WX\XSUMDAGSU.P SUMMER TIDREGTABAR/DAG   */
...
IF globforetag = "GKAL" THEN DO:   
    prognamnpers = "\\goliat\DELAD\server\PRO9S\autotidpers.txt".                   
    prognamnque = "\\goliat\DELAD\server\PRO9S\autotid.txt".                   
END.
...
OPEN QUERY sumq FOR EACH SUMTIDDAG WHERE YEAR(SUMTIDDAG.DATUM) = 2010 NO-LOCK.
DO TRANSACTION:
...
PROCEDURE perskoll_UI:
   IF globforetag = "SUND" OR globforetag = "MISV" THEN musz = musz.
   ELSE RETURN.
...
PROCEDURE sumtid_UI:
   ...
   OPEN QUERY tidq FOR EACH TIDREGITAB WHERE YEAR(TIDREGITAB.DATUM) = 2010 AND
   ...
   DO WHILE AVAILABLE(TIDREGITAB):
      ...
      /*ÄVEN ANDRA */               
      /*FAKTFORE*/
      IF globforetag = "GRAN" OR globforetag = "sund" OR globforetag = "MISV" OR globforetag = "elpa" THEN DO:
...
PROCEDURE sumtidfel_UI:      
   ...
   OPEN QUERY feltidq FOR EACH TIDFEL WHERE YEAR(TIDFEL.DATUM) = 2010 AND 
...
PROCEDURE sumtillfel_UI: 
   ...
   OPEN QUERY tidfelq FOR EACH TIDFEL WHERE YEAR(TIDFEL.DATUM) = 2010 AND 
   TIDFEL.FELKORD NE "" AND 
...
PROCEDURE sumeraallt_UI:
   ...
   ekoforst.DELNR BY ekoforst.PRISTYP:
      ...
      IF ekoforst.OANT1 NE 0  THEN DO:      
         ...
         IF globforetag = "NORD" OR globforetag = "ESAN" OR globforetag = "ESMA"
         OR globforetag = "SUND" OR globforetag = "MISV" OR globforetag = "GKAL" OR globforetag = "LULE" THEN DO:
            ASSIGN
