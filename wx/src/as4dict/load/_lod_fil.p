...
IF imod = "a" OR imod = "m" THEN DO:
  ...
  FOR EACH wfit:
     ...
     FIND as4dict.p__Trgfl WHERE as4dict.p__Trgfl._Event = wfit._Event 
     ...
     IF AVAILABLE as4dict.p__Trgfl THEN DO:
        ...
        IF  as4dict.p__Trgfl._Event     = wfit._Event
    ...
    /* Progress doesn't let you modify a trigger record, so delete and
     ...
     ASSIGN
        ...
        as4dict.p__Trgfl._Event       = wfit._Event
...
ASSIGN
  /* COMMENTED OUT MIGHT NEED drec_file   = RECID(as4dict.p__File) */
